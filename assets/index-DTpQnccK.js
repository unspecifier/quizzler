var Ut=Object.defineProperty;var Gt=(t,e,n)=>e in t?Ut(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var C=(t,e,n)=>Gt(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const Zt=!1;var mn=Array.isArray,gn=Array.from,Vt=Object.defineProperty,me=Object.getOwnPropertyDescriptor,rt=Object.getOwnPropertyDescriptors,Kt=Object.prototype,Xt=Array.prototype,Oe=Object.getPrototypeOf;function Yt(t){return t()}function an(t){for(var e=0;e<t.length;e++)t[e]()}const Y=2,ot=4,Ee=8,yn=16,j=32,qe=64,le=128,He=256,$=512,te=1024,ye=2048,G=4096,Re=8192,Jt=16384,bn=32768,ei=65536,ni=1<<18,at=1<<19,oe=Symbol("$state"),ti=Symbol("legacy props");function st(t){return t===this.v}function ii(t,e){return t!=t?e==e:t!==e||t!==null&&typeof t=="object"||typeof t=="function"}function vn(t){return!ii(t,this.v)}function ri(t){throw new Error("effect_in_teardown")}function oi(){throw new Error("effect_in_unowned_derived")}function ai(t){throw new Error("effect_orphan")}function si(){throw new Error("effect_update_depth_exceeded")}function li(t){throw new Error("props_invalid_value")}function ci(){throw new Error("state_descriptors_fixed")}function hi(){throw new Error("state_prototype_fixed")}function di(){throw new Error("state_unsafe_local_read")}function ui(){throw new Error("state_unsafe_mutation")}let be=!1;function pi(){be=!0}function O(t){return{f:0,v:t,reactions:null,equals:st,version:0}}function wn(t,e=!1){var i;const n=O(t);return e||(n.equals=vn),be&&_!==null&&_.l!==null&&((i=_.l).s??(i.s=[])).push(n),n}function X(t,e=!1){return fi(wn(t,e))}function fi(t){return A!==null&&A.f&Y&&(Z===null?zi([t]):Z.push(t)),t}function lt(t,e){return M(t,ae(()=>g(t))),e}function M(t,e){return A!==null&&Ye()&&A.f&(Y|yn)&&(Z===null||!Z.includes(t))&&ui(),ct(t,e)}function ct(t,e){return t.equals(e)||(t.v=e,t.version=_t(),ht(t,te),Ye()&&b!==null&&b.f&$&&!(b.f&j)&&(R!==null&&R.includes(t)?(F(b,te),Je(b)):ne===null?Bi([t]):ne.push(t))),e}function ht(t,e){var n=t.reactions;if(n!==null)for(var i=Ye(),r=n.length,o=0;o<r;o++){var a=n[o],c=a.f;c&te||!i&&a===b||(F(a,e),c&($|le)&&(c&Y?ht(a,ye):Je(a)))}}const mi=1,gi=2,yi=16,bi=1,vi=2,wi=4,ki=8,Ai=16,Ti=1,Ci=2,D=Symbol();let xi=!1;function pe(t,e=null,n){if(typeof t!="object"||t===null||oe in t)return t;const i=Oe(t);if(i!==Kt&&i!==Xt)return t;var r=new Map,o=mn(t),a=O(0);o&&r.set("length",O(t.length));var c;return new Proxy(t,{defineProperty(h,l,s){(!("value"in s)||s.configurable===!1||s.enumerable===!1||s.writable===!1)&&ci();var u=r.get(l);return u===void 0?(u=O(s.value),r.set(l,u)):M(u,pe(s.value,c)),!0},deleteProperty(h,l){var s=r.get(l);if(s===void 0)l in h&&r.set(l,O(D));else{if(o&&typeof l=="string"){var u=r.get("length"),d=Number(l);Number.isInteger(d)&&d<u.v&&M(u,d)}M(s,D),Wn(a)}return!0},get(h,l,s){var f;if(l===oe)return t;var u=r.get(l),d=l in h;if(u===void 0&&(!d||(f=me(h,l))!=null&&f.writable)&&(u=O(pe(d?h[l]:D,c)),r.set(l,u)),u!==void 0){var p=g(u);return p===D?void 0:p}return Reflect.get(h,l,s)},getOwnPropertyDescriptor(h,l){var s=Reflect.getOwnPropertyDescriptor(h,l);if(s&&"value"in s){var u=r.get(l);u&&(s.value=g(u))}else if(s===void 0){var d=r.get(l),p=d==null?void 0:d.v;if(d!==void 0&&p!==D)return{enumerable:!0,configurable:!0,value:p,writable:!0}}return s},has(h,l){var p;if(l===oe)return!0;var s=r.get(l),u=s!==void 0&&s.v!==D||Reflect.has(h,l);if(s!==void 0||b!==null&&(!u||(p=me(h,l))!=null&&p.writable)){s===void 0&&(s=O(u?pe(h[l],c):D),r.set(l,s));var d=g(s);if(d===D)return!1}return u},set(h,l,s,u){var I;var d=r.get(l),p=l in h;if(o&&l==="length")for(var f=s;f<d.v;f+=1){var m=r.get(f+"");m!==void 0?M(m,D):f in h&&(m=O(D),r.set(f+"",m))}d===void 0?(!p||(I=me(h,l))!=null&&I.writable)&&(d=O(void 0),M(d,pe(s,c)),r.set(l,d)):(p=d.v!==D,M(d,pe(s,c)));var y=Reflect.getOwnPropertyDescriptor(h,l);if(y!=null&&y.set&&y.set.call(u,s),!p){if(o&&typeof l=="string"){var v=r.get("length"),P=Number(l);Number.isInteger(P)&&P>=v.v&&M(v,P+1)}Wn(a)}return!0},ownKeys(h){g(a);var l=Reflect.ownKeys(h).filter(d=>{var p=r.get(d);return p===void 0||p.v!==D});for(var[s,u]of r)u.v!==D&&!(s in h)&&l.push(s);return l},setPrototypeOf(){hi()}})}function Wn(t,e=1){M(t,t.v+e)}var Dn,dt,ut;function _i(){if(Dn===void 0){Dn=window;var t=Element.prototype,e=Node.prototype;dt=me(e,"firstChild").get,ut=me(e,"nextSibling").get,t.__click=void 0,t.__className="",t.__attributes=null,t.__styles=null,t.__e=void 0,Text.prototype.__t=void 0}}function Pi(t=""){return document.createTextNode(t)}function Le(t){return dt.call(t)}function Xe(t){return ut.call(t)}function q(t,e){return Le(t)}function pt(t,e){{var n=Le(t);return n instanceof Comment&&n.data===""?Xe(n):n}}function W(t,e=1,n=!1){let i=t;for(;e--;)i=Xe(i);return i}function Mi(t){t.textContent=""}function je(t){var e=Y|te;b===null?e|=le:b.f|=at;const n={children:null,ctx:_,deps:null,equals:st,f:e,fn:t,reactions:null,v:null,version:0,parent:b};if(A!==null&&A.f&Y){var i=A;(i.children??(i.children=[])).push(n)}return n}function sn(t){const e=je(t);return e.equals=vn,e}function ft(t){var e=t.children;if(e!==null){t.children=null;for(var n=0;n<e.length;n+=1){var i=e[n];i.f&Y?kn(i):ce(i)}}}function mt(t){var e,n=b;V(t.parent);try{ft(t),e=Pt(t)}finally{V(n)}return e}function gt(t){var e=mt(t),n=(fe||t.f&le)&&t.deps!==null?ye:$;F(t,n),t.equals(e)||(t.v=e,t.version=_t())}function kn(t){ft(t),Se(t,0),F(t,Re),t.v=t.children=t.deps=t.ctx=t.reactions=null}function yt(t){b===null&&A===null&&ai(),A!==null&&A.f&le&&oi(),xn&&ri()}function Ii(t,e){var n=e.last;n===null?e.last=e.first=t:(n.next=t,t.prev=n,e.last=t)}function ve(t,e,n,i=!0){var r=(t&qe)!==0,o=b,a={ctx:_,deps:null,deriveds:null,nodes_start:null,nodes_end:null,f:t|te,first:null,fn:e,last:null,next:null,parent:r?null:o,prev:null,teardown:null,transitions:null,version:0};if(n){var c=ge;try{zn(!0),$e(a),a.f|=Jt}catch(s){throw ce(a),s}finally{zn(c)}}else e!==null&&Je(a);var h=n&&a.deps===null&&a.first===null&&a.nodes_start===null&&a.teardown===null&&(a.f&at)===0;if(!h&&!r&&i&&(o!==null&&Ii(a,o),A!==null&&A.f&Y)){var l=A;(l.children??(l.children=[])).push(a)}return a}function Si(t){const e=ve(Ee,null,!1);return F(e,$),e.teardown=t,e}function ln(t){yt();var e=b!==null&&(b.f&j)!==0&&_!==null&&!_.m;if(e){var n=_;(n.e??(n.e=[])).push({fn:t,effect:b,reaction:A})}else{var i=An(t);return i}}function Ei(t){return yt(),Qe(t)}function qi(t){const e=ve(qe,t,!0);return()=>{ce(e)}}function An(t){return ve(ot,t,!1)}function Ri(t,e){var n=_,i={effect:null,ran:!1};n.l.r1.push(i),i.effect=Qe(()=>{t(),!i.ran&&(i.ran=!0,M(n.l.r2,!0),ae(e))})}function Qi(){var t=_;Qe(()=>{if(g(t.l.r2)){for(var e of t.l.r1){var n=e.effect;n.f&$&&F(n,ye),we(n)&&$e(n),e.ran=!1}t.l.r2.v=!1}})}function Qe(t){return ve(Ee,t,!0)}function J(t){return Tn(t)}function Tn(t,e=0){return ve(Ee|yn|e,t,!0)}function Ie(t,e=!0){return ve(Ee|j,t,!0,e)}function bt(t){var e=t.teardown;if(e!==null){const n=xn,i=A;Bn(!0),ie(null);try{e.call(null)}finally{Bn(n),ie(i)}}}function vt(t){var e=t.deriveds;if(e!==null){t.deriveds=null;for(var n=0;n<e.length;n+=1)kn(e[n])}}function wt(t,e=!1){var n=t.first;for(t.first=t.last=null;n!==null;){var i=n.next;ce(n,e),n=i}}function $i(t){for(var e=t.first;e!==null;){var n=e.next;e.f&j||ce(e),e=n}}function ce(t,e=!0){var n=!1;if((e||t.f&ni)&&t.nodes_start!==null){for(var i=t.nodes_start,r=t.nodes_end;i!==null;){var o=i===r?null:Xe(i);i.remove(),i=o}n=!0}wt(t,e&&!n),vt(t),Se(t,0),F(t,Re);var a=t.transitions;if(a!==null)for(const h of a)h.stop();bt(t);var c=t.parent;c!==null&&c.first!==null&&kt(t),t.next=t.prev=t.teardown=t.ctx=t.deps=t.parent=t.fn=t.nodes_start=t.nodes_end=null}function kt(t){var e=t.parent,n=t.prev,i=t.next;n!==null&&(n.next=i),i!==null&&(i.prev=n),e!==null&&(e.first===t&&(e.first=i),e.last===t&&(e.last=n))}function cn(t,e){var n=[];Cn(t,n,!0),At(n,()=>{ce(t),e&&e()})}function At(t,e){var n=t.length;if(n>0){var i=()=>--n||e();for(var r of t)r.out(i)}else e()}function Cn(t,e,n){if(!(t.f&G)){if(t.f^=G,t.transitions!==null)for(const a of t.transitions)(a.is_global||n)&&e.push(a);for(var i=t.first;i!==null;){var r=i.next,o=(i.f&bn)!==0||(i.f&j)!==0;Cn(i,e,o?n:!1),i=r}}}function Fe(t){Tt(t,!0)}function Tt(t,e){if(t.f&G){we(t)&&$e(t),t.f^=G;for(var n=t.first;n!==null;){var i=n.next,r=(n.f&bn)!==0||(n.f&j)!==0;Tt(n,r?e:!1),n=i}if(t.transitions!==null)for(const o of t.transitions)(o.is_global||e)&&o.in()}}let hn=!1,dn=[];function Wi(){hn=!1;const t=dn.slice();dn=[],an(t)}function Ct(t){hn||(hn=!0,queueMicrotask(Wi)),dn.push(t)}function Di(t){throw new Error("lifecycle_outside_component")}let Ue=!1,ge=!1,xn=!1;function zn(t){ge=t}function Bn(t){xn=t}let un=[],_e=0;let A=null;function ie(t){A=t}let b=null;function V(t){b=t}let Z=null;function zi(t){Z=t}let R=null,z=0,ne=null;function Bi(t){ne=t}let xt=0,fe=!1,_=null;function _t(){return++xt}function Ye(){return!be||_!==null&&_.l===null}function we(t){var a,c;var e=t.f;if(e&te)return!0;if(e&ye){var n=t.deps,i=(e&le)!==0;if(n!==null){var r;if(e&He){for(r=0;r<n.length;r++)((a=n[r]).reactions??(a.reactions=[])).push(t);t.f^=He}for(r=0;r<n.length;r++){var o=n[r];if(we(o)&&gt(o),i&&b!==null&&!fe&&!((c=o==null?void 0:o.reactions)!=null&&c.includes(t))&&(o.reactions??(o.reactions=[])).push(t),o.version>t.version)return!0}}i||F(t,$)}return!1}function Ni(t,e,n){throw t}function Pt(t){var d;var e=R,n=z,i=ne,r=A,o=fe,a=Z,c=_,h=t.f;R=null,z=0,ne=null,A=h&(j|qe)?null:t,fe=!ge&&(h&le)!==0,Z=null,_=t.ctx;try{var l=(0,t.fn)(),s=t.deps;if(R!==null){var u;if(Se(t,z),s!==null&&z>0)for(s.length=z+R.length,u=0;u<R.length;u++)s[z+u]=R[u];else t.deps=s=R;if(!fe)for(u=z;u<s.length;u++)((d=s[u]).reactions??(d.reactions=[])).push(t)}else s!==null&&z<s.length&&(Se(t,z),s.length=z);return l}finally{R=e,z=n,ne=i,A=r,fe=o,Z=a,_=c}}function Oi(t,e){let n=e.reactions;if(n!==null){var i=n.indexOf(t);if(i!==-1){var r=n.length-1;r===0?n=e.reactions=null:(n[i]=n[r],n.pop())}}n===null&&e.f&Y&&(R===null||!R.includes(e))&&(F(e,ye),e.f&(le|He)||(e.f^=He),Se(e,0))}function Se(t,e){var n=t.deps;if(n!==null)for(var i=e;i<n.length;i++)Oi(t,n[i])}function $e(t){var e=t.f;if(!(e&Re)){F(t,$);var n=b;b=t;try{e&yn?$i(t):wt(t),vt(t),bt(t);var i=Pt(t);t.teardown=typeof i=="function"?i:null,t.version=xt}catch(r){Ni(r)}finally{b=n}}}function Hi(){_e>1e3&&(_e=0,si()),_e++}function Li(t){var e=t.length;if(e!==0){Hi();var n=ge;ge=!0;try{for(var i=0;i<e;i++){var r=t[i];r.f&$||(r.f^=$);var o=[];Mt(r,o),ji(o)}}finally{ge=n}}}function ji(t){var e=t.length;if(e!==0)for(var n=0;n<e;n++){var i=t[n];!(i.f&(Re|G))&&we(i)&&($e(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?kt(i):i.fn=null))}}function Fi(){if(Ue=!1,_e>1001)return;const t=un;un=[],Li(t),Ue||(_e=0)}function Je(t){Ue||(Ue=!0,queueMicrotask(Fi));for(var e=t;e.parent!==null;){e=e.parent;var n=e.f;if(n&(qe|j)){if(!(n&$))return;e.f^=$}}un.push(e)}function Mt(t,e){var n=t.first,i=[];e:for(;n!==null;){var r=n.f,o=(r&j)!==0,a=o&&(r&$)!==0;if(!a&&!(r&G))if(r&Ee){o?n.f^=$:we(n)&&$e(n);var c=n.first;if(c!==null){n=c;continue}}else r&ot&&i.push(n);var h=n.next;if(h===null){let u=n.parent;for(;u!==null;){if(t===u)break e;var l=u.next;if(l!==null){n=l;continue e}u=u.parent}}n=h}for(var s=0;s<i.length;s++)c=i[s],e.push(c),Mt(c,e)}function g(t){var c;var e=t.f,n=(e&Y)!==0;if(n&&e&Re){var i=mt(t);return kn(t),i}if(A!==null){Z!==null&&Z.includes(t)&&di();var r=A.deps;R===null&&r!==null&&r[z]===t?z++:R===null?R=[t]:R.push(t),ne!==null&&b!==null&&b.f&$&&!(b.f&j)&&ne.includes(t)&&(F(b,te),Je(b))}else if(n&&t.deps===null){var o=t,a=o.parent;a!==null&&!((c=a.deriveds)!=null&&c.includes(o))&&(a.deriveds??(a.deriveds=[])).push(o)}return n&&(o=t,we(o)&&gt(o)),t.v}function ae(t){const e=A;try{return A=null,t()}finally{A=e}}const Ui=~(te|ye|$);function F(t,e){t.f=t.f&Ui|e}function Nn(t,e=1){var n=+g(t);return M(t,n+e),n}function _n(t,e=!1,n){_={p:_,c:null,e:null,m:!1,s:t,x:null,l:null},be&&!e&&(_.l={s:null,u:null,r1:[],r2:O(!1)})}function Pn(t){const e=_;if(e!==null){const a=e.e;if(a!==null){var n=b,i=A;e.e=null;try{for(var r=0;r<a.length;r++){var o=a[r];V(o.effect),ie(o.reaction),An(o.fn)}}finally{V(n),ie(i)}}_=e.p,e.m=!0}return{}}function Gi(t){if(!(typeof t!="object"||!t||t instanceof EventTarget)){if(oe in t)pn(t);else if(!Array.isArray(t))for(let e in t){const n=t[e];typeof n=="object"&&n&&oe in n&&pn(n)}}}function pn(t,e=new Set){if(typeof t=="object"&&t!==null&&!(t instanceof EventTarget)&&!e.has(t)){e.add(t),t instanceof Date&&t.getTime();for(let i in t)try{pn(t[i],e)}catch{}const n=Oe(t);if(n!==Object.prototype&&n!==Array.prototype&&n!==Map.prototype&&n!==Set.prototype&&n!==Date.prototype){const i=rt(n);for(let r in i){const o=i[r].get;if(o)try{o.call(t)}catch{}}}}}let On=!1;function Zi(){On||(On=!0,document.addEventListener("reset",t=>{Promise.resolve().then(()=>{var e;if(!t.defaultPrevented)for(const n of t.target.elements)(e=n.__on_r)==null||e.call(n)})},{capture:!0}))}function It(t){var e=A,n=b;ie(null),V(null);try{return t()}finally{ie(e),V(n)}}function Vi(t,e,n,i=n){t.addEventListener(e,()=>It(n));const r=t.__on_r;r?t.__on_r=()=>{r(),i()}:t.__on_r=i,Zi()}const Ki=new Set,Hn=new Set;function Xi(t,e,n,i){function r(o){if(i.capture||xe.call(e,o),!o.cancelBubble)return It(()=>n.call(this,o))}return t.startsWith("pointer")||t.startsWith("touch")||t==="wheel"?Ct(()=>{e.addEventListener(t,r,i)}):e.addEventListener(t,r,i),r}function Ge(t,e,n,i,r){var o={capture:i,passive:r},a=Xi(t,e,n,o);(e===document.body||e===window||e===document)&&Si(()=>{e.removeEventListener(t,a,o)})}function xe(t){var P;var e=this,n=e.ownerDocument,i=t.type,r=((P=t.composedPath)==null?void 0:P.call(t))||[],o=r[0]||t.target,a=0,c=t.__root;if(c){var h=r.indexOf(c);if(h!==-1&&(e===document||e===window)){t.__root=e;return}var l=r.indexOf(e);if(l===-1)return;h<=l&&(a=h)}if(o=r[a]||t.target,o!==e){Vt(t,"currentTarget",{configurable:!0,get(){return o||n}});var s=A,u=b;ie(null),V(null);try{for(var d,p=[];o!==null;){var f=o.assignedSlot||o.parentNode||o.host||null;try{var m=o["__"+i];if(m!==void 0&&!o.disabled)if(mn(m)){var[y,...v]=m;y.apply(o,[t,...v])}else m.call(o,t)}catch(I){d?p.push(I):d=I}if(t.cancelBubble||f===e||f===null)break;o=f}if(d){for(let I of p)queueMicrotask(()=>{throw I});throw d}}finally{t.__root=e,delete t.currentTarget,ie(s),V(u)}}}function Yi(t){var e=document.createElement("template");return e.innerHTML=t,e.content}function Ln(t,e){var n=b;n.nodes_start===null&&(n.nodes_start=t,n.nodes_end=e)}function he(t,e){var n=(e&Ti)!==0,i=(e&Ci)!==0,r,o=!t.startsWith("<!>");return()=>{r===void 0&&(r=Yi(o?t:"<!>"+t),n||(r=Le(r)));var a=i?document.importNode(r,!0):r.cloneNode(!0);if(n){var c=Le(a),h=a.lastChild;Ln(c,h)}else Ln(a,a);return a}}function re(t,e){t!==null&&t.before(e)}const Ji=["touchstart","touchmove"];function er(t){return Ji.includes(t)}function Ae(t,e){var n=e==null?"":typeof e=="object"?e+"":e;n!==(t.__t??(t.__t=t.nodeValue))&&(t.__t=n,t.nodeValue=n==null?"":n+"")}function nr(t,e){return tr(t,e)}const ue=new Map;function tr(t,{target:e,anchor:n,props:i={},events:r,context:o,intro:a=!0}){_i();var c=new Set,h=u=>{for(var d=0;d<u.length;d++){var p=u[d];if(!c.has(p)){c.add(p);var f=er(p);e.addEventListener(p,xe,{passive:f});var m=ue.get(p);m===void 0?(document.addEventListener(p,xe,{passive:f}),ue.set(p,1)):ue.set(p,m+1)}}};h(gn(Ki)),Hn.add(h);var l=void 0,s=qi(()=>{var u=n??e.appendChild(Pi());return Ie(()=>{if(o){_n({});var d=_;d.c=o}r&&(i.$$events=r),l=t(u,i)||{},o&&Pn()}),()=>{var f;for(var d of c){e.removeEventListener(d,xe);var p=ue.get(d);--p===0?(document.removeEventListener(d,xe),ue.delete(d)):ue.set(d,p)}Hn.delete(h),jn.delete(l),u!==n&&((f=u.parentNode)==null||f.removeChild(u))}});return jn.set(l,s),l}let jn=new WeakMap;function St(t,e,n,i=null,r=!1){var o=t,a=null,c=null,h=null,l=r?bn:0;Tn(()=>{h!==(h=!!e())&&(h?(a?Fe(a):a=Ie(()=>n(o)),c&&cn(c,()=>{c=null})):(c?Fe(c):i&&(c=Ie(()=>i(o))),a&&cn(a,()=>{a=null})))},l)}function ir(t,e){return e}function rr(t,e,n,i){for(var r=[],o=e.length,a=0;a<o;a++)Cn(e[a].e,r,!0);var c=o>0&&r.length===0&&n!==null;if(c){var h=n.parentNode;Mi(h),h.append(n),i.clear(),ee(t,e[0].prev,e[o-1].next)}At(r,()=>{for(var l=0;l<o;l++){var s=e[l];c||(i.delete(s.k),ee(t,s.prev,s.next)),ce(s.e,!c)}})}function or(t,e,n,i,r,o=null){var a=t,c={flags:e,items:new Map,first:null},h=null,l=!1;Tn(()=>{var s=n(),u=mn(s)?s:s==null?[]:gn(s),d=u.length;if(!(l&&d===0)){l=d===0;{var p=A;ar(u,c,a,r,e,(p.f&G)!==0,i)}o!==null&&(d===0?h?Fe(h):h=Ie(()=>o(a)):h!==null&&cn(h,()=>{h=null})),n()}})}function ar(t,e,n,i,r,o,a){var c=t.length,h=e.items,l=e.first,s=l,u,d=null,p=[],f=[],m,y,v,P;for(P=0;P<c;P+=1){if(m=t[P],y=a(m,P),v=h.get(y),v===void 0){var I=s?s.e.nodes_start:n;d=lr(I,e,d,d===null?e.first:d.next,m,y,P,i,r),h.set(y,d),p=[],f=[],s=d.next;continue}if(sr(v,m,P),v.e.f&G&&Fe(v.e),v!==s){if(u!==void 0&&u.has(v)){if(p.length<f.length){var B=f[0],x;d=B.prev;var S=p[0],E=p[p.length-1];for(x=0;x<p.length;x+=1)Fn(p[x],B,n);for(x=0;x<f.length;x+=1)u.delete(f[x]);ee(e,S.prev,E.next),ee(e,d,S),ee(e,E,B),s=B,d=E,P-=1,p=[],f=[]}else u.delete(v),Fn(v,s,n),ee(e,v.prev,v.next),ee(e,v,d===null?e.first:d.next),ee(e,d,v),d=v;continue}for(p=[],f=[];s!==null&&s.k!==y;)(o||!(s.e.f&G))&&(u??(u=new Set)).add(s),f.push(s),s=s.next;if(s===null)continue;v=s}p.push(v),d=v,s=v.next}if(s!==null||u!==void 0){for(var w=u===void 0?[]:gn(u);s!==null;)(o||!(s.e.f&G))&&w.push(s),s=s.next;var N=w.length;if(N>0){var K=null;rr(e,w,K,h)}}b.first=e.first&&e.first.e,b.last=d&&d.e}function sr(t,e,n,i){ct(t.v,e),t.i=n}function lr(t,e,n,i,r,o,a,c,h){var l=(h&mi)!==0,s=(h&yi)===0,u=l?s?wn(r):O(r):r,d=h&gi?O(a):a,p={i:d,v:u,k:o,a:null,e:null,prev:n,next:i};try{return p.e=Ie(()=>c(t,u,d),xi),p.e.prev=n&&n.e,p.e.next=i&&i.e,n===null?e.first=p:(n.next=p,n.e.next=p.e),i!==null&&(i.prev=p,i.e.prev=p.e),p}finally{}}function Fn(t,e,n){for(var i=t.next?t.next.e.nodes_start:n,r=e?e.e.nodes_start:n,o=t.e.nodes_start;o!==i;){var a=Xe(o);r.before(o),o=a}}function ee(t,e,n){e===null?t.first=n:(e.next=n,e.e.next=n&&n.e),n!==null&&(n.prev=e,n.e.prev=e&&e.e)}function cr(t,e,n,i){var r=t.__attributes??(t.__attributes={});r[e]!==(r[e]=n)&&(n==null?t.removeAttribute(e):typeof n!="string"&&hr(t).includes(e)?t[e]=n:t.setAttribute(e,n))}var Un=new Map;function hr(t){var e=Un.get(t.nodeName);if(e)return e;Un.set(t.nodeName,e=[]);for(var n,i=Oe(t),r=Element.prototype;r!==i;){n=rt(i);for(var o in n)n[o].set&&e.push(o);i=Oe(i)}return e}function Gn(t,e,n){if(n){if(t.classList.contains(e))return;t.classList.add(e)}else{if(!t.classList.contains(e))return;t.classList.remove(e)}}function dr(t,e,n=e){var i=Ye();Vi(t,"input",()=>{var r=Zn(t)?Vn(t.value):t.value;n(r),i&&r!==(r=e())&&(t.value=r??"")}),Qe(()=>{var r=e();Zn(t)&&r===Vn(t.value)||t.type==="date"&&!r&&!t.value||r!==t.value&&(t.value=r??"")})}function Zn(t){var e=t.type;return e==="number"||e==="range"}function Vn(t){return t===""?null:+t}function Kn(t,e){return t===e||(t==null?void 0:t[oe])===e}function ur(t={},e,n,i){return An(()=>{var r,o;return Qe(()=>{r=o,o=[],ae(()=>{t!==n(...o)&&(e(t,...o),r&&Kn(n(...r),t)&&e(null,...r))})}),()=>{Ct(()=>{o&&Kn(n(...o),t)&&e(null,...o)})}}),t}function Et(t=!1){const e=_,n=e.l.u;if(!n)return;let i=()=>Gi(e.s);if(t){let r=0,o={};const a=je(()=>{let c=!1;const h=e.s;for(const l in h)h[l]!==o[l]&&(o[l]=h[l],c=!0);return c&&r++,r});i=()=>g(a)}n.b.length&&Ei(()=>{Xn(e,i),an(n.b)}),ln(()=>{const r=ae(()=>n.m.map(Yt));return()=>{for(const o of r)typeof o=="function"&&o()}}),n.a.length&&ln(()=>{Xn(e,i),an(n.a)})}function Xn(t,e){if(t.l.s)for(const n of t.l.s)g(n);e()}let ze=!1;function pr(t){var e=ze;try{return ze=!1,[t(),ze]}finally{ze=e}}function Yn(t){for(var e=b,n=b;e!==null&&!(e.f&(j|qe));)e=e.parent;try{return V(e),t()}finally{V(n)}}function Ne(t,e,n,i){var E;var r=(n&bi)!==0,o=!be||(n&vi)!==0,a=(n&ki)!==0,c=(n&Ai)!==0,h=!1,l;a?[l,h]=pr(()=>t[e]):l=t[e];var s=oe in t||ti in t,u=((E=me(t,e))==null?void 0:E.set)??(s&&a&&e in t?w=>t[e]=w:void 0),d=i,p=!0,f=!1,m=()=>(f=!0,p&&(p=!1,c?d=ae(i):d=i),d);l===void 0&&i!==void 0&&(u&&o&&li(),l=m(),u&&u(l));var y;if(o)y=()=>{var w=t[e];return w===void 0?m():(p=!0,f=!1,w)};else{var v=Yn(()=>(r?je:sn)(()=>t[e]));v.f|=ei,y=()=>{var w=g(v);return w!==void 0&&(d=void 0),w===void 0?d:w}}if(!(n&wi))return y;if(u){var P=t.$$legacy;return function(w,N){return arguments.length>0?((!o||!N||P||h)&&u(N?y():w),w):y()}}var I=!1,B=!1,x=wn(l),S=Yn(()=>je(()=>{var w=y(),N=g(x);return I?(I=!1,B=!0,N):(B=!1,x.v=w)}));return r||(S.equals=vn),function(w,N){if(arguments.length>0){const K=N?g(S):o&&a?pe(w):w;return S.equals(K)||(I=!0,M(x,K),f&&d!==void 0&&(d=K),ae(()=>g(S))),w}return g(S)}}function qt(t){_===null&&Di(),be&&_.l!==null?fr(_).m.push(t):ln(()=>{const e=ae(t);if(typeof e=="function")return e})}function fr(t){var e=t.l;return e.u??(e.u={a:[],b:[],m:[]})}const mr="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(mr);pi();function Rt(t){let e=t.length;for(;e!=0;){let n=Math.floor(Math.random()*e);e--,[t[e],t[n]]=[t[n],t[e]]}return t}function gr(t){const n=new Date().getTime()-t.getTime();if(n<0)throw new Error("The provided date is in the future.");const i=Math.floor(n/(1e3*60*60)),r=Math.floor(n%(1e3*60*60)/(1e3*60)),o=Math.floor(n%(1e3*60)/1e3);return[i.toString().padStart(2,"0"),r.toString().padStart(2,"0"),o.toString().padStart(2,"0")].join(":")}var yr=he('<form class="svelte-sav0zk"><fieldset class="svelte-sav0zk"></fieldset> <footer class="svelte-sav0zk"><button type="submit" class="svelte-sav0zk">Submit</button></footer></form>');function br(t,e){_n(e,!1);let n=Ne(e,"onSubmit",8),i=Ne(e,"answered",8,!1),r=Ne(e,"src",8),o=X(document.createElement("fieldset"));function a(l){l.preventDefault();const s=l.target;if(!(s instanceof HTMLFormElement))throw new Error("Not a form");const d=new FormData(s).get("answer");return n()(d==="correct"),!0}qt(()=>{var u;lt(o,g(o).innerHTML=r());const l=g(o).querySelector("ul");if(!l)throw new Error("No answer set");const s=Rt(Array.from(l.children));for(const d of s){const p=d.innerHTML,f=((u=d.textContent)==null?void 0:u.startsWith("✅"))??!1,m=document.createElement("label");m.className="grid grid-cols-[1.5rem,1fr] gap-x-2 items-baseline",m.innerHTML=p.replace(/[✅❌] /g,"");const y=document.createElement("input");y.type="radio",y.name="answer",y.required=!0,f&&(y.value="correct"),m.prepend(y),d.replaceChildren(m),d.className="mb-4",l.appendChild(d)}}),Et();var c=yr(),h=q(c);ur(h,l=>M(o,l),()=>g(o)),J(()=>cr(c,"data-answered",i())),Ge("submit",c,a),re(t,c),Pn()}const vr=`## Question: 1 of 125\r
\r
...
- ❌ Plan
> The plan section includes the provider's treatment plan for the patient.`;function Mn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let de=Mn();function Qt(t){de=t}const Pe={exec:()=>null};function T(t,e=""){let n=typeof t=="string"?t:t.source;const i={replace:(r,o)=>{let a=typeof o=="string"?o:o.source;return a=a.replace(Q.caret,"$1"),n=n.replace(r,a),i},getRegex:()=>new RegExp(n,e)};return i}const Q={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i")},kr=/^(?:[ \t]*(?:\n|$))+/,Ar=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Tr=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,We=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Cr=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,$t=/(?:[*+-]|\d{1,9}[.)])/,Wt=T(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,$t).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),In=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,xr=/^[^\n]+/,Sn=/(?!\s*\])(?:\\.|[^\[\]\\])+/,_r=T(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Sn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Pr=T(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,$t).getRegex(),en="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",En=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mr=T("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",En).replace("tag",en).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Dt=T(In).replace("hr",We).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",en).getRegex(),Ir=T(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Dt).getRegex(),qn={blockquote:Ir,code:Ar,def:_r,fences:Tr,heading:Cr,hr:We,html:Mr,lheading:Wt,list:Pr,newline:kr,paragraph:Dt,table:Pe,text:xr},Jn=T("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",We).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",en).getRegex(),Sr={...qn,table:Jn,paragraph:T(In).replace("hr",We).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Jn).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",en).getRegex()},Er={...qn,html:T(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",En).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Pe,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:T(In).replace("hr",We).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Wt).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},zt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,qr=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Bt=/^( {2,}|\\)\n(?!\s*$)/,Rr=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,nn=/[\p{P}\p{S}]/u,Rn=/[\s\p{P}\p{S}]/u,Nt=/[^\s\p{P}\p{S}]/u,Qr=T(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Rn).getRegex(),$r=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,Wr=T(/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,"u").replace(/punct/g,nn).getRegex(),Dr=T("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)","gu").replace(/notPunctSpace/g,Nt).replace(/punctSpace/g,Rn).replace(/punct/g,nn).getRegex(),zr=T("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Nt).replace(/punctSpace/g,Rn).replace(/punct/g,nn).getRegex(),Br=T(/\\(punct)/,"gu").replace(/punct/g,nn).getRegex(),Nr=T(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Or=T(En).replace("(?:-->|$)","-->").getRegex(),Hr=T("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Or).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ze=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Lr=T(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",Ze).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Ot=T(/^!?\[(label)\]\[(ref)\]/).replace("label",Ze).replace("ref",Sn).getRegex(),Ht=T(/^!?\[(ref)\](?:\[\])?/).replace("ref",Sn).getRegex(),jr=T("reflink|nolink(?!\\()","g").replace("reflink",Ot).replace("nolink",Ht).getRegex(),Qn={_backpedal:Pe,anyPunctuation:Br,autolink:Nr,blockSkip:$r,br:Bt,code:qr,del:Pe,emStrongLDelim:Wr,emStrongRDelimAst:Dr,emStrongRDelimUnd:zr,escape:zt,link:Lr,nolink:Ht,punctuation:Qr,reflink:Ot,reflinkSearch:jr,tag:Hr,text:Rr,url:Pe},Fr={...Qn,link:T(/^!?\[(label)\]\((.*?)\)/).replace("label",Ze).getRegex(),reflink:T(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ze).getRegex()},fn={...Qn,escape:T(zt).replace("])","~|])").getRegex(),url:T(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Ur={...fn,br:T(Bt).replace("{2,}","*").getRegex(),text:T(fn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Be={normal:qn,gfm:Sr,pedantic:Er},Te={normal:Qn,gfm:fn,breaks:Ur,pedantic:Fr},Gr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},et=t=>Gr[t];function U(t,e){if(e){if(Q.escapeTest.test(t))return t.replace(Q.escapeReplace,et)}else if(Q.escapeTestNoEncode.test(t))return t.replace(Q.escapeReplaceNoEncode,et);return t}function nt(t){try{t=encodeURI(t).replace(Q.percentDecode,"%")}catch{return null}return t}function tt(t,e){var o;const n=t.replace(Q.findPipe,(a,c,h)=>{let l=!1,s=c;for(;--s>=0&&h[s]==="\\";)l=!l;return l?"|":" |"}),i=n.split(Q.splitPipe);let r=0;if(i[0].trim()||i.shift(),i.length>0&&!((o=i.at(-1))!=null&&o.trim())&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(Q.slashPipe,"|");return i}function Ce(t,e,n){const i=t.length;if(i===0)return"";let r=0;for(;r<i;){const o=t.charAt(i-r-1);if(o===e&&!n)r++;else if(o!==e&&n)r++;else break}return t.slice(0,i-r)}function Zr(t,e){if(t.indexOf(e[1])===-1)return-1;let n=0;for(let i=0;i<t.length;i++)if(t[i]==="\\")i++;else if(t[i]===e[0])n++;else if(t[i]===e[1]&&(n--,n<0))return i;return-1}function it(t,e,n,i,r){const o=e.href,a=e.title||null,c=t[1].replace(r.other.outputLinkReplace,"$1");if(t[0].charAt(0)!=="!"){i.state.inLink=!0;const h={type:"link",raw:n,href:o,title:a,text:c,tokens:i.inlineTokens(c)};return i.state.inLink=!1,h}return{type:"image",raw:n,href:o,title:a,text:c}}function Vr(t,e,n){const i=t.match(n.other.indentCodeCompensation);if(i===null)return e;const r=i[1];return e.split(`
...
`)}class Ve{constructor(e){C(this,"options");C(this,"rules");C(this,"lexer");this.options=e||de}space(e){const n=this.rules.block.newline.exec(e);if(n&&n[0].length>0)return{type:"space",raw:n[0]}}code(e){const n=this.rules.block.code.exec(e);if(n){const i=n[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:n[0],codeBlockStyle:"indented",text:this.options.pedantic?i:Ce(i,`
`)}}}fences(e){const n=this.rules.block.fences.exec(e);if(n){const i=n[0],r=Vr(i,n[3]||"",this.rules);return{type:"code",raw:i,lang:n[2]?n[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):n[2],text:r}}}heading(e){const n=this.rules.block.heading.exec(e);if(n){let i=n[2].trim();if(this.rules.other.endingHash.test(i)){const r=Ce(i,"#");(this.options.pedantic||!r||this.rules.other.endingSpaceChar.test(r))&&(i=r.trim())}return{type:"heading",raw:n[0],depth:n[1].length,text:i,tokens:this.lexer.inline(i)}}}hr(e){const n=this.rules.block.hr.exec(e);if(n)return{type:"hr",raw:Ce(n[0],`
`)}}blockquote(e){const n=this.rules.block.blockquote.exec(e);if(n){let i=Ce(n[0],`
`).split(`
`),r="",o="";const a=[];for(;i.length>0;){let c=!1;const h=[];let l;for(l=0;l<i.length;l++)if(this.rules.other.blockquoteStart.test(i[l]))h.push(i[l]),c=!0;else if(!c)h.push(i[l]);else break;i=i.slice(l);const s=h.join(`
`),u=s.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");r=r?`${r}
${s}`:s,o=o?`${o}
${u}`:u;const d=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(u,a,!0),this.lexer.state.top=d,i.length===0)break;const p=a.at(-1);if((p==null?void 0:p.type)==="code")break;if((p==null?void 0:p.type)==="blockquote"){const f=p,m=f.raw+`
`+i.join(`
...
`+c.raw,l.text+=`
`+c.raw,this.inlineQueue.at(-1).src=l.text):this.tokens.links[c.tag]||(this.tokens.links[c.tag]={href:c.href,title:c.title});continue}if(c=this.tokenizer.table(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.lheading(e)){e=e.substring(c.raw.length),n.push(c);continue}let h=e;if((a=this.options.extensions)!=null&&a.startBlock){let l=1/0;const s=e.slice(1);let u;this.options.extensions.startBlock.forEach(d=>{u=d.call({lexer:this},s),typeof u=="number"&&u>=0&&(l=Math.min(l,u))}),l<1/0&&l>=0&&(h=e.substring(0,l+1))}if(this.state.top&&(c=this.tokenizer.paragraph(h))){const l=n.at(-1);i&&(l==null?void 0:l.type)==="paragraph"?(l.raw+=`
`+c.raw,l.text+=`
`+c.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=l.text):n.push(c),i=h.length!==e.length,e=e.substring(c.raw.length);continue}if(c=this.tokenizer.text(e)){e=e.substring(c.raw.length);const l=n.at(-1);(l==null?void 0:l.type)==="text"?(l.raw+=`
`+c.raw,l.text+=`
`+c.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=l.text):n.push(c);continue}if(e){const l="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(l);break}else throw new Error(l)}}return this.state.top=!0,n}inline(e,n=[]){return this.inlineQueue.push({src:e,tokens:n}),n}inlineTokens(e,n=[]){var c,h,l;let i=e,r=null;if(this.tokens.links){const s=Object.keys(this.tokens.links);if(s.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)s.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)i=i.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(r=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,r.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o=!1,a="";for(;e;){o||(a=""),o=!1;let s;if((h=(c=this.options.extensions)==null?void 0:c.inline)!=null&&h.some(d=>(s=d.call({lexer:this},e,n))?(e=e.substring(s.raw.length),n.push(s),!0):!1))continue;if(s=this.tokenizer.escape(e)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.tag(e)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.link(e)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(s.raw.length);const d=n.at(-1);s.type==="text"&&(d==null?void 0:d.type)==="text"?(d.raw+=s.raw,d.text+=s.text):n.push(s);continue}if(s=this.tokenizer.emStrong(e,i,a)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.codespan(e)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.br(e)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.del(e)){e=e.substring(s.raw.length),n.push(s);continue}if(s=this.tokenizer.autolink(e)){e=e.substring(s.raw.length),n.push(s);continue}if(!this.state.inLink&&(s=this.tokenizer.url(e))){e=e.substring(s.raw.length),n.push(s);continue}let u=e;if((l=this.options.extensions)!=null&&l.startInline){let d=1/0;const p=e.slice(1);let f;this.options.extensions.startInline.forEach(m=>{f=m.call({lexer:this},p),typeof f=="number"&&f>=0&&(d=Math.min(d,f))}),d<1/0&&d>=0&&(u=e.substring(0,d+1))}if(s=this.tokenizer.inlineText(u)){e=e.substring(s.raw.length),s.raw.slice(-1)!=="_"&&(a=s.raw.slice(-1)),o=!0;const d=n.at(-1);(d==null?void 0:d.type)==="text"?(d.raw+=s.raw,d.text+=s.text):n.push(s);continue}if(e){const d="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(d);break}else throw new Error(d)}}return n}}class Ke{constructor(e){C(this,"options");C(this,"parser");this.options=e||de}space(e){return""}code({text:e,lang:n,escaped:i}){var a;const r=(a=(n||"").match(Q.notSpaceStart))==null?void 0:a[0],o=e.replace(Q.endingNewline,"")+`
...
`}hr(e){return`<hr>
`}list(e){const n=e.ordered,i=e.start;let r="";for(let c=0;c<e.items.length;c++){const h=e.items[c];r+=this.listitem(h)}const o=n?"ol":"ul",a=n&&i!==1?' start="'+i+'"':"";return"<"+o+a+`>
`+r+"</"+o+`>
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${U(e,!0)}</code>`}br(e){return"<br>"}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:n,tokens:i}){const r=this.parser.parseInline(i),o=nt(e);if(o===null)return r;e=o;let a='<a href="'+e+'"';return n&&(a+=' title="'+U(n)+'"'),a+=">"+r+"</a>",a}image({href:e,title:n,text:i}){const r=nt(e);if(r===null)return U(i);e=r;let o=`<img src="${e}" alt="${i}"`;return n&&(o+=` title="${U(n)}"`),o+=">",o}text(e){return"tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):"escaped"in e&&e.escaped?e.text:U(e.text)}}class $n{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return""+e}image({text:e}){return""+e}br(){return""}}class L{constructor(e){C(this,"options");C(this,"renderer");C(this,"textRenderer");this.options=e||de,this.options.renderer=this.options.renderer||new Ke,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new $n}static parse(e,n){return new L(n).parse(e)}static parseInline(e,n){return new L(n).parseInline(e)}parse(e,n=!0){var r,o;let i="";for(let a=0;a<e.length;a++){const c=e[a];if((o=(r=this.options.extensions)==null?void 0:r.renderers)!=null&&o[c.type]){const l=c,s=this.options.extensions.renderers[l.type].call({parser:this},l);if(s!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(l.type)){i+=s||"";continue}}const h=c;switch(h.type){case"space":{i+=this.renderer.space(h);continue}case"hr":{i+=this.renderer.hr(h);continue}case"heading":{i+=this.renderer.heading(h);continue}case"code":{i+=this.renderer.code(h);continue}case"table":{i+=this.renderer.table(h);continue}case"blockquote":{i+=this.renderer.blockquote(h);continue}case"list":{i+=this.renderer.list(h);continue}case"html":{i+=this.renderer.html(h);continue}case"paragraph":{i+=this.renderer.paragraph(h);continue}case"text":{let l=h,s=this.renderer.text(l);for(;a+1<e.length&&e[a+1].type==="text";)l=e[++a],s+=`
`+this.renderer.text(l);n?i+=this.renderer.paragraph({type:"paragraph",raw:s,text:s,tokens:[{type:"text",raw:s,text:s,escaped:!0}]}):i+=s;continue}default:{const l='Token with "'+h.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return i}parseInline(e,n=this.renderer){var r,o;let i="";for(let a=0;a<e.length;a++){const c=e[a];if((o=(r=this.options.extensions)==null?void 0:r.renderers)!=null&&o[c.type]){const l=this.options.extensions.renderers[c.type].call({parser:this},c);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(c.type)){i+=l||"";continue}}const h=c;switch(h.type){case"escape":{i+=n.text(h);break}case"html":{i+=n.html(h);break}case"link":{i+=n.link(h);break}case"image":{i+=n.image(h);break}case"strong":{i+=n.strong(h);break}case"em":{i+=n.em(h);break}case"codespan":{i+=n.codespan(h);break}case"br":{i+=n.br(h);break}case"del":{i+=n.del(h);break}case"text":{i+=n.text(h);break}default:{const l='Token with "'+h.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return i}}class Me{constructor(e){C(this,"options");C(this,"block");this.options=e||de}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}provideLexer(){return this.block?H.lex:H.lexInline}provideParser(){return this.block?L.parse:L.parseInline}}C(Me,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));class Kr{constructor(...e){C(this,"defaults",Mn());C(this,"options",this.setOptions);C(this,"parse",this.parseMarkdown(!0));C(this,"parseInline",this.parseMarkdown(!1));C(this,"Parser",L);C(this,"Renderer",Ke);C(this,"TextRenderer",$n);C(this,"Lexer",H);C(this,"Tokenizer",Ve);C(this,"Hooks",Me);this.use(...e)}walkTokens(e,n){var r,o;let i=[];for(const a of e)switch(i=i.concat(n.call(this,a)),a.type){case"table":{const c=a;for(const h of c.header)i=i.concat(this.walkTokens(h.tokens,n));for(const h of c.rows)for(const l of h)i=i.concat(this.walkTokens(l.tokens,n));break}case"list":{const c=a;i=i.concat(this.walkTokens(c.items,n));break}default:{const c=a;(o=(r=this.defaults.extensions)==null?void 0:r.childTokens)!=null&&o[c.type]?this.defaults.extensions.childTokens[c.type].forEach(h=>{const l=c[h].flat(1/0);i=i.concat(this.walkTokens(l,n))}):c.tokens&&(i=i.concat(this.walkTokens(c.tokens,n)))}}return i}use(...e){const n=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(i=>{const r={...i};if(r.async=this.defaults.async||r.async||!1,i.extensions&&(i.extensions.forEach(o=>{if(!o.name)throw new Error("extension name required");if("renderer"in o){const a=n.renderers[o.name];a?n.renderers[o.name]=function(...c){let h=o.renderer.apply(this,c);return h===!1&&(h=a.apply(this,c)),h}:n.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const a=n[o.level];a?a.unshift(o.tokenizer):n[o.level]=[o.tokenizer],o.start&&(o.level==="block"?n.startBlock?n.startBlock.push(o.start):n.startBlock=[o.start]:o.level==="inline"&&(n.startInline?n.startInline.push(o.start):n.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(n.childTokens[o.name]=o.childTokens)}),r.extensions=n),i.renderer){const o=this.defaults.renderer||new Ke(this.defaults);for(const a in i.renderer){if(!(a in o))throw new Error(`renderer '${a}' does not exist`);if(["options","parser"].includes(a))continue;const c=a,h=i.renderer[c],l=o[c];o[c]=(...s)=>{let u=h.apply(o,s);return u===!1&&(u=l.apply(o,s)),u||""}}r.renderer=o}if(i.tokenizer){const o=this.defaults.tokenizer||new Ve(this.defaults);for(const a in i.tokenizer){if(!(a in o))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;const c=a,h=i.tokenizer[c],l=o[c];o[c]=(...s)=>{let u=h.apply(o,s);return u===!1&&(u=l.apply(o,s)),u}}r.tokenizer=o}if(i.hooks){const o=this.defaults.hooks||new Me;for(const a in i.hooks){if(!(a in o))throw new Error(`hook '${a}' does not exist`);if(["options","block"].includes(a))continue;const c=a,h=i.hooks[c],l=o[c];Me.passThroughHooks.has(a)?o[c]=s=>{if(this.defaults.async)return Promise.resolve(h.call(o,s)).then(d=>l.call(o,d));const u=h.call(o,s);return l.call(o,u)}:o[c]=(...s)=>{let u=h.apply(o,s);return u===!1&&(u=l.apply(o,s)),u}}r.hooks=o}if(i.walkTokens){const o=this.defaults.walkTokens,a=i.walkTokens;r.walkTokens=function(c){let h=[];return h.push(a.call(this,c)),o&&(h=h.concat(o.call(this,c))),h}}this.defaults={...this.defaults,...r}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,n){return H.lex(e,n??this.defaults)}parser(e,n){return L.parse(e,n??this.defaults)}parseMarkdown(e){return(i,r)=>{const o={...r},a={...this.defaults,...o},c=this.onError(!!a.silent,!!a.async);if(this.defaults.async===!0&&o.async===!1)return c(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof i>"u"||i===null)return c(new Error("marked(): input parameter is undefined or null"));if(typeof i!="string")return c(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(i)+", string expected"));a.hooks&&(a.hooks.options=a,a.hooks.block=e);const h=a.hooks?a.hooks.provideLexer():e?H.lex:H.lexInline,l=a.hooks?a.hooks.provideParser():e?L.parse:L.parseInline;if(a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(i):i).then(s=>h(s,a)).then(s=>a.hooks?a.hooks.processAllTokens(s):s).then(s=>a.walkTokens?Promise.all(this.walkTokens(s,a.walkTokens)).then(()=>s):s).then(s=>l(s,a)).then(s=>a.hooks?a.hooks.postprocess(s):s).catch(c);try{a.hooks&&(i=a.hooks.preprocess(i));let s=h(i,a);a.hooks&&(s=a.hooks.processAllTokens(s)),a.walkTokens&&this.walkTokens(s,a.walkTokens);let u=l(s,a);return a.hooks&&(u=a.hooks.postprocess(u)),u}catch(s){return c(s)}}}onError(e,n){return i=>{if(i.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+U(i.message+"",!0)+"</pre>";return n?Promise.resolve(r):r}if(n)return Promise.reject(i);throw i}}}const se=new Kr;function k(t,e){return se.parse(t,e)}k.options=k.setOptions=function(t){return se.setOptions(t),k.defaults=se.defaults,Qt(k.defaults),k};k.getDefaults=Mn;k.defaults=de;k.use=function(...t){return se.use(...t),k.defaults=se.defaults,Qt(k.defaults),k};k.walkTokens=function(t,e){return se.walkTokens(t,e)};k.parseInline=se.parseInline;k.Parser=L;k.parser=L.parse;k.Renderer=Ke;k.TextRenderer=$n;k.Lexer=H;k.lexer=H.lex;k.Tokenizer=Ve;k.Hooks=Me;k.parse=k;k.options;k.setOptions;k.use;k.walkTokens;k.parseInline;L.parse;H.lex;var Xr=he('<div class="svelte-1d0jhup"><!></div>'),Yr=he('<fieldset class="fancy"><legend> </legend> <!></fieldset>'),Jr=he('<h2 style="font-size: 1.5rem; font-weight: medium; margin: 0">Final Score</h2> <div style="font-size: 2rem; font-weight: bold; text-align: center; margin-bottom: 1rem" class="score svelte-1d0jhup"> </div> <table style="margin: auto"><tbody><tr><th>Correct</th><td> </td></tr><tr><th>Incorrect</th><td> </td></tr></tbody></table>',1),eo=he('<article><h1 class="font-bold mb-6 svelte-1d0jhup">NHA Baseline Test</h1> <nav class="svelte-1d0jhup"><button type="button" class="svelte-1d0jhup">Previous</button> <div class="timer svelte-1d0jhup">Timer <time class="svelte-1d0jhup"> </time></div> <button type="button" class="svelte-1d0jhup">Next</button></nav> <!></article>');function no(t,e){_n(e,!1);let n=Ne(e,"num_questions",12,5),i=X(),r=X(0),o=X([]),a,c=X(),h=X("00:00:00"),l=X(!1);function s(){g(r)<=g(i).length&&Nn(r)}function u(x){return k(x,{async:!1}).split(/^<h2>.+<\/h2>\n/gm).filter(Boolean)}qt(()=>{M(i,[...u(vr),...u(wr)]),Rt(g(i)),M(i,g(i).slice(0,n())),n(g(i).length),M(o,new Array(n()).fill(void 0)),a=new Date,M(c,setInterval(()=>{M(h,gr(a))},1e3))});function d(x){lt(o,g(o)[g(r)]=x)}Ri(()=>(g(l),g(o),g(c)),()=>{M(l,g(o).every(x=>typeof x=="boolean")),g(l)&&clearInterval(g(c))}),Qi(),Et();var p=eo(),f=W(q(p),2),m=q(f),y=W(m,2),v=W(q(y)),P=q(v),I=W(y,2),B=W(f,2);St(B,()=>g(r)<n(),x=>{var S=Yr(),E=q(S),w=q(E),N=W(E,2);or(N,1,()=>g(i),ir,(K,tn,De)=>{var ke=Xr(),rn=q(ke),on=sn(()=>typeof g(o)[g(r)]=="boolean");br(rn,{get src(){return g(tn)},onSubmit:d,get answered(){return g(on)}}),J(()=>Gn(ke,"hidden",g(r)!==De)),re(K,ke)}),J(()=>{S.disabled=typeof g(o)[g(r)]=="boolean",Ae(w,`Question: ${g(r)+1} of ${n()??""}`)}),re(x,S)},x=>{var S=Jr(),E=W(pt(S),2);const w=sn(()=>g(o).filter(Boolean).length/n()*100<70);J(()=>Gn(E,"failed",g(w)));var N=q(E);J(()=>Ae(N,`${(g(o).filter(Boolean).length/n()*100).toFixed(2)??""}%`));var K=W(E,2),tn=q(K),De=q(tn),ke=W(q(De)),rn=q(ke);J(()=>Ae(rn,`${g(o).filter(Boolean).length??""} out of ${n()??""}`));var on=W(De),Lt=W(q(on)),jt=q(Lt);J(()=>Ae(jt,`${g(o).filter(Ft=>!Ft).length??""} out of ${n()??""}`)),re(x,S)}),J(()=>{m.disabled=g(r)===0,Ae(P,g(h)),I.disabled=g(r)===n()||typeof g(o)[g(r)]!="boolean"}),Ge("click",m,()=>Nn(r,-1)),Ge("click",I,s),re(t,p),Pn()}var to=he('<header class="mb-6"><h1 class="mb-2 text-5xl font-bold">The Quizzler</h1> <p class="text-center text-xl">Medical Coding Edition</p></header> <fieldset class="fancy flex flex-col items-center justify-center gap-2"><label for="numquestions">How many questions?</label> <input type="number" id="numquestions" min="1" class="pl-2 py-1 rounded"> <button class="mt-4">Start</button></fieldset>',1),io=he("<main><!></main>");function ro(t){let e=X(225),n=X(!1);var i=io(),r=q(i);St(r,()=>!g(n),o=>{var a=to(),c=W(pt(a),2),h=W(q(c),2),l=W(h,2);dr(h,()=>g(e),s=>M(e,s)),Ge("click",l,()=>M(n,!0)),re(o,a)},o=>{no(o,{get num_questions(){return g(e)}})}),re(t,i)}nr(ro,{target:document.getElementById("app")});
