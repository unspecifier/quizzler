var Ut=Object.defineProperty;var Gt=(t,e,n)=>e in t?Ut(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var C=(t,e,n)=>Gt(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const Zt=!1;var mn=Array.isArray,gn=Array.from,Vt=Object.defineProperty,me=Object.getOwnPropertyDescriptor,rt=Object.getOwnPropertyDescriptors,Kt=Object.prototype,Xt=Array.prototype,Oe=Object.getPrototypeOf;function Yt(t){return t()}function an(t){for(var e=0;e<t.length;e++)t[e]()}const Y=2,ot=4,Ee=8,yn=16,j=32,qe=64,le=128,He=256,$=512,te=1024,ye=2048,G=4096,Re=8192,Jt=16384,bn=32768,ei=65536,ni=1<<18,at=1<<19,oe=Symbol("$state"),ti=Symbol("legacy props");function st(t){return t===this.v}function ii(t,e){return t!=t?e==e:t!==e||t!==null&&typeof t=="object"||typeof t=="function"}function vn(t){return!ii(t,this.v)}function ri(t){throw new Error("effect_in_teardown")}function oi(){throw new Error("effect_in_unowned_derived")}function ai(t){throw new Error("effect_orphan")}function si(){throw new Error("effect_update_depth_exceeded")}function li(t){throw new Error("props_invalid_value")}function ci(){throw new Error("state_descriptors_fixed")}function di(){throw new Error("state_prototype_fixed")}function hi(){throw new Error("state_unsafe_local_read")}function ui(){throw new Error("state_unsafe_mutation")}let be=!1;function pi(){be=!0}function O(t){return{f:0,v:t,reactions:null,equals:st,version:0}}function wn(t,e=!1){var i;const n=O(t);return e||(n.equals=vn),be&&_!==null&&_.l!==null&&((i=_.l).s??(i.s=[])).push(n),n}function X(t,e=!1){return fi(wn(t,e))}function fi(t){return A!==null&&A.f&Y&&(Z===null?zi([t]):Z.push(t)),t}function lt(t,e){return M(t,ae(()=>g(t))),e}function M(t,e){return A!==null&&Ye()&&A.f&(Y|yn)&&(Z===null||!Z.includes(t))&&ui(),ct(t,e)}function ct(t,e){return t.equals(e)||(t.v=e,t.version=_t(),dt(t,te),Ye()&&b!==null&&b.f&$&&!(b.f&j)&&(R!==null&&R.includes(t)?(F(b,te),Je(b)):ne===null?Bi([t]):ne.push(t))),e}function dt(t,e){var n=t.reactions;if(n!==null)for(var i=Ye(),r=n.length,o=0;o<r;o++){var a=n[o],c=a.f;c&te||!i&&a===b||(F(a,e),c&($|le)&&(c&Y?dt(a,ye):Je(a)))}}const mi=1,gi=2,yi=16,bi=1,vi=2,wi=4,ki=8,Ai=16,Ti=1,Ci=2,D=Symbol();let xi=!1;function pe(t,e=null,n){if(typeof t!="object"||t===null||oe in t)return t;const i=Oe(t);if(i!==Kt&&i!==Xt)return t;var r=new Map,o=mn(t),a=O(0);o&&r.set("length",O(t.length));var c;return new Proxy(t,{defineProperty(d,l,s){(!("value"in s)||s.configurable===!1||s.enumerable===!1||s.writable===!1)&&ci();var u=r.get(l);return u===void 0?(u=O(s.value),r.set(l,u)):M(u,pe(s.value,c)),!0},deleteProperty(d,l){var s=r.get(l);if(s===void 0)l in d&&r.set(l,O(D));else{if(o&&typeof l=="string"){var u=r.get("length"),h=Number(l);Number.isInteger(h)&&h<u.v&&M(u,h)}M(s,D),Wn(a)}return!0},get(d,l,s){var f;if(l===oe)return t;var u=r.get(l),h=l in d;if(u===void 0&&(!h||(f=me(d,l))!=null&&f.writable)&&(u=O(pe(h?d[l]:D,c)),r.set(l,u)),u!==void 0){var p=g(u);return p===D?void 0:p}return Reflect.get(d,l,s)},getOwnPropertyDescriptor(d,l){var s=Reflect.getOwnPropertyDescriptor(d,l);if(s&&"value"in s){var u=r.get(l);u&&(s.value=g(u))}else if(s===void 0){var h=r.get(l),p=h==null?void 0:h.v;if(h!==void 0&&p!==D)return{enumerable:!0,configurable:!0,value:p,writable:!0}}return s},has(d,l){var p;if(l===oe)return!0;var s=r.get(l),u=s!==void 0&&s.v!==D||Reflect.has(d,l);if(s!==void 0||b!==null&&(!u||(p=me(d,l))!=null&&p.writable)){s===void 0&&(s=O(u?pe(d[l],c):D),r.set(l,s));var h=g(s);if(h===D)return!1}return u},set(d,l,s,u){var I;var h=r.get(l),p=l in d;if(o&&l==="length")for(var f=s;f<h.v;f+=1){var m=r.get(f+"");m!==void 0?M(m,D):f in d&&(m=O(D),r.set(f+"",m))}h===void 0?(!p||(I=me(d,l))!=null&&I.writable)&&(h=O(void 0),M(h,pe(s,c)),r.set(l,h)):(p=h.v!==D,M(h,pe(s,c)));var y=Reflect.getOwnPropertyDescriptor(d,l);if(y!=null&&y.set&&y.set.call(u,s),!p){if(o&&typeof l=="string"){var v=r.get("length"),P=Number(l);Number.isInteger(P)&&P>=v.v&&M(v,P+1)}Wn(a)}return!0},ownKeys(d){g(a);var l=Reflect.ownKeys(d).filter(h=>{var p=r.get(h);return p===void 0||p.v!==D});for(var[s,u]of r)u.v!==D&&!(s in d)&&l.push(s);return l},setPrototypeOf(){di()}})}function Wn(t,e=1){M(t,t.v+e)}var Dn,ht,ut;function _i(){if(Dn===void 0){Dn=window;var t=Element.prototype,e=Node.prototype;ht=me(e,"firstChild").get,ut=me(e,"nextSibling").get,t.__click=void 0,t.__className="",t.__attributes=null,t.__styles=null,t.__e=void 0,Text.prototype.__t=void 0}}function Pi(t=""){return document.createTextNode(t)}function Le(t){return ht.call(t)}function Xe(t){return ut.call(t)}function q(t,e){return Le(t)}function pt(t,e){{var n=Le(t);return n instanceof Comment&&n.data===""?Xe(n):n}}function W(t,e=1,n=!1){let i=t;for(;e--;)i=Xe(i);return i}function Mi(t){t.textContent=""}function je(t){var e=Y|te;b===null?e|=le:b.f|=at;const n={children:null,ctx:_,deps:null,equals:st,f:e,fn:t,reactions:null,v:null,version:0,parent:b};if(A!==null&&A.f&Y){var i=A;(i.children??(i.children=[])).push(n)}return n}function sn(t){const e=je(t);return e.equals=vn,e}function ft(t){var e=t.children;if(e!==null){t.children=null;for(var n=0;n<e.length;n+=1){var i=e[n];i.f&Y?kn(i):ce(i)}}}function mt(t){var e,n=b;V(t.parent);try{ft(t),e=Pt(t)}finally{V(n)}return e}function gt(t){var e=mt(t),n=(fe||t.f&le)&&t.deps!==null?ye:$;F(t,n),t.equals(e)||(t.v=e,t.version=_t())}function kn(t){ft(t),Se(t,0),F(t,Re),t.v=t.children=t.deps=t.ctx=t.reactions=null}function yt(t){b===null&&A===null&&ai(),A!==null&&A.f&le&&oi(),xn&&ri()}function Ii(t,e){var n=e.last;n===null?e.last=e.first=t:(n.next=t,t.prev=n,e.last=t)}function ve(t,e,n,i=!0){var r=(t&qe)!==0,o=b,a={ctx:_,deps:null,deriveds:null,nodes_start:null,nodes_end:null,f:t|te,first:null,fn:e,last:null,next:null,parent:r?null:o,prev:null,teardown:null,transitions:null,version:0};if(n){var c=ge;try{zn(!0),$e(a),a.f|=Jt}catch(s){throw ce(a),s}finally{zn(c)}}else e!==null&&Je(a);var d=n&&a.deps===null&&a.first===null&&a.nodes_start===null&&a.teardown===null&&(a.f&at)===0;if(!d&&!r&&i&&(o!==null&&Ii(a,o),A!==null&&A.f&Y)){var l=A;(l.children??(l.children=[])).push(a)}return a}function Si(t){const e=ve(Ee,null,!1);return F(e,$),e.teardown=t,e}function ln(t){yt();var e=b!==null&&(b.f&j)!==0&&_!==null&&!_.m;if(e){var n=_;(n.e??(n.e=[])).push({fn:t,effect:b,reaction:A})}else{var i=An(t);return i}}function Ei(t){return yt(),Qe(t)}function qi(t){const e=ve(qe,t,!0);return()=>{ce(e)}}function An(t){return ve(ot,t,!1)}function Ri(t,e){var n=_,i={effect:null,ran:!1};n.l.r1.push(i),i.effect=Qe(()=>{t(),!i.ran&&(i.ran=!0,M(n.l.r2,!0),ae(e))})}function Qi(){var t=_;Qe(()=>{if(g(t.l.r2)){for(var e of t.l.r1){var n=e.effect;n.f&$&&F(n,ye),we(n)&&$e(n),e.ran=!1}t.l.r2.v=!1}})}function Qe(t){return ve(Ee,t,!0)}function J(t){return Tn(t)}function Tn(t,e=0){return ve(Ee|yn|e,t,!0)}function Ie(t,e=!0){return ve(Ee|j,t,!0,e)}function bt(t){var e=t.teardown;if(e!==null){const n=xn,i=A;Bn(!0),ie(null);try{e.call(null)}finally{Bn(n),ie(i)}}}function vt(t){var e=t.deriveds;if(e!==null){t.deriveds=null;for(var n=0;n<e.length;n+=1)kn(e[n])}}function wt(t,e=!1){var n=t.first;for(t.first=t.last=null;n!==null;){var i=n.next;ce(n,e),n=i}}function $i(t){for(var e=t.first;e!==null;){var n=e.next;e.f&j||ce(e),e=n}}function ce(t,e=!0){var n=!1;if((e||t.f&ni)&&t.nodes_start!==null){for(var i=t.nodes_start,r=t.nodes_end;i!==null;){var o=i===r?null:Xe(i);i.remove(),i=o}n=!0}wt(t,e&&!n),vt(t),Se(t,0),F(t,Re);var a=t.transitions;if(a!==null)for(const d of a)d.stop();bt(t);var c=t.parent;c!==null&&c.first!==null&&kt(t),t.next=t.prev=t.teardown=t.ctx=t.deps=t.parent=t.fn=t.nodes_start=t.nodes_end=null}function kt(t){var e=t.parent,n=t.prev,i=t.next;n!==null&&(n.next=i),i!==null&&(i.prev=n),e!==null&&(e.first===t&&(e.first=i),e.last===t&&(e.last=n))}function cn(t,e){var n=[];Cn(t,n,!0),At(n,()=>{ce(t),e&&e()})}function At(t,e){var n=t.length;if(n>0){var i=()=>--n||e();for(var r of t)r.out(i)}else e()}function Cn(t,e,n){if(!(t.f&G)){if(t.f^=G,t.transitions!==null)for(const a of t.transitions)(a.is_global||n)&&e.push(a);for(var i=t.first;i!==null;){var r=i.next,o=(i.f&bn)!==0||(i.f&j)!==0;Cn(i,e,o?n:!1),i=r}}}function Fe(t){Tt(t,!0)}function Tt(t,e){if(t.f&G){we(t)&&$e(t),t.f^=G;for(var n=t.first;n!==null;){var i=n.next,r=(n.f&bn)!==0||(n.f&j)!==0;Tt(n,r?e:!1),n=i}if(t.transitions!==null)for(const o of t.transitions)(o.is_global||e)&&o.in()}}let dn=!1,hn=[];function Wi(){dn=!1;const t=hn.slice();hn=[],an(t)}function Ct(t){dn||(dn=!0,queueMicrotask(Wi)),hn.push(t)}function Di(t){throw new Error("lifecycle_outside_component")}let Ue=!1,ge=!1,xn=!1;function zn(t){ge=t}function Bn(t){xn=t}let un=[],_e=0;let A=null;function ie(t){A=t}let b=null;function V(t){b=t}let Z=null;function zi(t){Z=t}let R=null,z=0,ne=null;function Bi(t){ne=t}let xt=0,fe=!1,_=null;function _t(){return++xt}function Ye(){return!be||_!==null&&_.l===null}function we(t){var a,c;var e=t.f;if(e&te)return!0;if(e&ye){var n=t.deps,i=(e&le)!==0;if(n!==null){var r;if(e&He){for(r=0;r<n.length;r++)((a=n[r]).reactions??(a.reactions=[])).push(t);t.f^=He}for(r=0;r<n.length;r++){var o=n[r];if(we(o)&&gt(o),i&&b!==null&&!fe&&!((c=o==null?void 0:o.reactions)!=null&&c.includes(t))&&(o.reactions??(o.reactions=[])).push(t),o.version>t.version)return!0}}i||F(t,$)}return!1}function Ni(t,e,n){throw t}function Pt(t){var h;var e=R,n=z,i=ne,r=A,o=fe,a=Z,c=_,d=t.f;R=null,z=0,ne=null,A=d&(j|qe)?null:t,fe=!ge&&(d&le)!==0,Z=null,_=t.ctx;try{var l=(0,t.fn)(),s=t.deps;if(R!==null){var u;if(Se(t,z),s!==null&&z>0)for(s.length=z+R.length,u=0;u<R.length;u++)s[z+u]=R[u];else t.deps=s=R;if(!fe)for(u=z;u<s.length;u++)((h=s[u]).reactions??(h.reactions=[])).push(t)}else s!==null&&z<s.length&&(Se(t,z),s.length=z);return l}finally{R=e,z=n,ne=i,A=r,fe=o,Z=a,_=c}}function Oi(t,e){let n=e.reactions;if(n!==null){var i=n.indexOf(t);if(i!==-1){var r=n.length-1;r===0?n=e.reactions=null:(n[i]=n[r],n.pop())}}n===null&&e.f&Y&&(R===null||!R.includes(e))&&(F(e,ye),e.f&(le|He)||(e.f^=He),Se(e,0))}function Se(t,e){var n=t.deps;if(n!==null)for(var i=e;i<n.length;i++)Oi(t,n[i])}function $e(t){var e=t.f;if(!(e&Re)){F(t,$);var n=b;b=t;try{e&yn?$i(t):wt(t),vt(t),bt(t);var i=Pt(t);t.teardown=typeof i=="function"?i:null,t.version=xt}catch(r){Ni(r)}finally{b=n}}}function Hi(){_e>1e3&&(_e=0,si()),_e++}function Li(t){var e=t.length;if(e!==0){Hi();var n=ge;ge=!0;try{for(var i=0;i<e;i++){var r=t[i];r.f&$||(r.f^=$);var o=[];Mt(r,o),ji(o)}}finally{ge=n}}}function ji(t){var e=t.length;if(e!==0)for(var n=0;n<e;n++){var i=t[n];!(i.f&(Re|G))&&we(i)&&($e(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?kt(i):i.fn=null))}}function Fi(){if(Ue=!1,_e>1001)return;const t=un;un=[],Li(t),Ue||(_e=0)}function Je(t){Ue||(Ue=!0,queueMicrotask(Fi));for(var e=t;e.parent!==null;){e=e.parent;var n=e.f;if(n&(qe|j)){if(!(n&$))return;e.f^=$}}un.push(e)}function Mt(t,e){var n=t.first,i=[];e:for(;n!==null;){var r=n.f,o=(r&j)!==0,a=o&&(r&$)!==0;if(!a&&!(r&G))if(r&Ee){o?n.f^=$:we(n)&&$e(n);var c=n.first;if(c!==null){n=c;continue}}else r&ot&&i.push(n);var d=n.next;if(d===null){let u=n.parent;for(;u!==null;){if(t===u)break e;var l=u.next;if(l!==null){n=l;continue e}u=u.parent}}n=d}for(var s=0;s<i.length;s++)c=i[s],e.push(c),Mt(c,e)}function g(t){var c;var e=t.f,n=(e&Y)!==0;if(n&&e&Re){var i=mt(t);return kn(t),i}if(A!==null){Z!==null&&Z.includes(t)&&hi();var r=A.deps;R===null&&r!==null&&r[z]===t?z++:R===null?R=[t]:R.push(t),ne!==null&&b!==null&&b.f&$&&!(b.f&j)&&ne.includes(t)&&(F(b,te),Je(b))}else if(n&&t.deps===null){var o=t,a=o.parent;a!==null&&!((c=a.deriveds)!=null&&c.includes(o))&&(a.deriveds??(a.deriveds=[])).push(o)}return n&&(o=t,we(o)&&gt(o)),t.v}function ae(t){const e=A;try{return A=null,t()}finally{A=e}}const Ui=~(te|ye|$);function F(t,e){t.f=t.f&Ui|e}function Nn(t,e=1){var n=+g(t);return M(t,n+e),n}function _n(t,e=!1,n){_={p:_,c:null,e:null,m:!1,s:t,x:null,l:null},be&&!e&&(_.l={s:null,u:null,r1:[],r2:O(!1)})}function Pn(t){const e=_;if(e!==null){const a=e.e;if(a!==null){var n=b,i=A;e.e=null;try{for(var r=0;r<a.length;r++){var o=a[r];V(o.effect),ie(o.reaction),An(o.fn)}}finally{V(n),ie(i)}}_=e.p,e.m=!0}return{}}function Gi(t){if(!(typeof t!="object"||!t||t instanceof EventTarget)){if(oe in t)pn(t);else if(!Array.isArray(t))for(let e in t){const n=t[e];typeof n=="object"&&n&&oe in n&&pn(n)}}}function pn(t,e=new Set){if(typeof t=="object"&&t!==null&&!(t instanceof EventTarget)&&!e.has(t)){e.add(t),t instanceof Date&&t.getTime();for(let i in t)try{pn(t[i],e)}catch{}const n=Oe(t);if(n!==Object.prototype&&n!==Array.prototype&&n!==Map.prototype&&n!==Set.prototype&&n!==Date.prototype){const i=rt(n);for(let r in i){const o=i[r].get;if(o)try{o.call(t)}catch{}}}}}let On=!1;function Zi(){On||(On=!0,document.addEventListener("reset",t=>{Promise.resolve().then(()=>{var e;if(!t.defaultPrevented)for(const n of t.target.elements)(e=n.__on_r)==null||e.call(n)})},{capture:!0}))}function It(t){var e=A,n=b;ie(null),V(null);try{return t()}finally{ie(e),V(n)}}function Vi(t,e,n,i=n){t.addEventListener(e,()=>It(n));const r=t.__on_r;r?t.__on_r=()=>{r(),i()}:t.__on_r=i,Zi()}const Ki=new Set,Hn=new Set;function Xi(t,e,n,i){function r(o){if(i.capture||xe.call(e,o),!o.cancelBubble)return It(()=>n.call(this,o))}return t.startsWith("pointer")||t.startsWith("touch")||t==="wheel"?Ct(()=>{e.addEventListener(t,r,i)}):e.addEventListener(t,r,i),r}function Ge(t,e,n,i,r){var o={capture:i,passive:r},a=Xi(t,e,n,o);(e===document.body||e===window||e===document)&&Si(()=>{e.removeEventListener(t,a,o)})}function xe(t){var P;var e=this,n=e.ownerDocument,i=t.type,r=((P=t.composedPath)==null?void 0:P.call(t))||[],o=r[0]||t.target,a=0,c=t.__root;if(c){var d=r.indexOf(c);if(d!==-1&&(e===document||e===window)){t.__root=e;return}var l=r.indexOf(e);if(l===-1)return;d<=l&&(a=d)}if(o=r[a]||t.target,o!==e){Vt(t,"currentTarget",{configurable:!0,get(){return o||n}});var s=A,u=b;ie(null),V(null);try{for(var h,p=[];o!==null;){var f=o.assignedSlot||o.parentNode||o.host||null;try{var m=o["__"+i];if(m!==void 0&&!o.disabled)if(mn(m)){var[y,...v]=m;y.apply(o,[t,...v])}else m.call(o,t)}catch(I){h?p.push(I):h=I}if(t.cancelBubble||f===e||f===null)break;o=f}if(h){for(let I of p)queueMicrotask(()=>{throw I});throw h}}finally{t.__root=e,delete t.currentTarget,ie(s),V(u)}}}function Yi(t){var e=document.createElement("template");return e.innerHTML=t,e.content}function Ln(t,e){var n=b;n.nodes_start===null&&(n.nodes_start=t,n.nodes_end=e)}function de(t,e){var n=(e&Ti)!==0,i=(e&Ci)!==0,r,o=!t.startsWith("<!>");return()=>{r===void 0&&(r=Yi(o?t:"<!>"+t),n||(r=Le(r)));var a=i?document.importNode(r,!0):r.cloneNode(!0);if(n){var c=Le(a),d=a.lastChild;Ln(c,d)}else Ln(a,a);return a}}function re(t,e){t!==null&&t.before(e)}const Ji=["touchstart","touchmove"];function er(t){return Ji.includes(t)}function Ae(t,e){var n=e==null?"":typeof e=="object"?e+"":e;n!==(t.__t??(t.__t=t.nodeValue))&&(t.__t=n,t.nodeValue=n==null?"":n+"")}function nr(t,e){return tr(t,e)}const ue=new Map;function tr(t,{target:e,anchor:n,props:i={},events:r,context:o,intro:a=!0}){_i();var c=new Set,d=u=>{for(var h=0;h<u.length;h++){var p=u[h];if(!c.has(p)){c.add(p);var f=er(p);e.addEventListener(p,xe,{passive:f});var m=ue.get(p);m===void 0?(document.addEventListener(p,xe,{passive:f}),ue.set(p,1)):ue.set(p,m+1)}}};d(gn(Ki)),Hn.add(d);var l=void 0,s=qi(()=>{var u=n??e.appendChild(Pi());return Ie(()=>{if(o){_n({});var h=_;h.c=o}r&&(i.$$events=r),l=t(u,i)||{},o&&Pn()}),()=>{var f;for(var h of c){e.removeEventListener(h,xe);var p=ue.get(h);--p===0?(document.removeEventListener(h,xe),ue.delete(h)):ue.set(h,p)}Hn.delete(d),jn.delete(l),u!==n&&((f=u.parentNode)==null||f.removeChild(u))}});return jn.set(l,s),l}let jn=new WeakMap;function St(t,e,n,i=null,r=!1){var o=t,a=null,c=null,d=null,l=r?bn:0;Tn(()=>{d!==(d=!!e())&&(d?(a?Fe(a):a=Ie(()=>n(o)),c&&cn(c,()=>{c=null})):(c?Fe(c):i&&(c=Ie(()=>i(o))),a&&cn(a,()=>{a=null})))},l)}function ir(t,e){return e}function rr(t,e,n,i){for(var r=[],o=e.length,a=0;a<o;a++)Cn(e[a].e,r,!0);var c=o>0&&r.length===0&&n!==null;if(c){var d=n.parentNode;Mi(d),d.append(n),i.clear(),ee(t,e[0].prev,e[o-1].next)}At(r,()=>{for(var l=0;l<o;l++){var s=e[l];c||(i.delete(s.k),ee(t,s.prev,s.next)),ce(s.e,!c)}})}function or(t,e,n,i,r,o=null){var a=t,c={flags:e,items:new Map,first:null},d=null,l=!1;Tn(()=>{var s=n(),u=mn(s)?s:s==null?[]:gn(s),h=u.length;if(!(l&&h===0)){l=h===0;{var p=A;ar(u,c,a,r,e,(p.f&G)!==0,i)}o!==null&&(h===0?d?Fe(d):d=Ie(()=>o(a)):d!==null&&cn(d,()=>{d=null})),n()}})}function ar(t,e,n,i,r,o,a){var c=t.length,d=e.items,l=e.first,s=l,u,h=null,p=[],f=[],m,y,v,P;for(P=0;P<c;P+=1){if(m=t[P],y=a(m,P),v=d.get(y),v===void 0){var I=s?s.e.nodes_start:n;h=lr(I,e,h,h===null?e.first:h.next,m,y,P,i,r),d.set(y,h),p=[],f=[],s=h.next;continue}if(sr(v,m,P),v.e.f&G&&Fe(v.e),v!==s){if(u!==void 0&&u.has(v)){if(p.length<f.length){var B=f[0],x;h=B.prev;var S=p[0],E=p[p.length-1];for(x=0;x<p.length;x+=1)Fn(p[x],B,n);for(x=0;x<f.length;x+=1)u.delete(f[x]);ee(e,S.prev,E.next),ee(e,h,S),ee(e,E,B),s=B,h=E,P-=1,p=[],f=[]}else u.delete(v),Fn(v,s,n),ee(e,v.prev,v.next),ee(e,v,h===null?e.first:h.next),ee(e,h,v),h=v;continue}for(p=[],f=[];s!==null&&s.k!==y;)(o||!(s.e.f&G))&&(u??(u=new Set)).add(s),f.push(s),s=s.next;if(s===null)continue;v=s}p.push(v),h=v,s=v.next}if(s!==null||u!==void 0){for(var w=u===void 0?[]:gn(u);s!==null;)(o||!(s.e.f&G))&&w.push(s),s=s.next;var N=w.length;if(N>0){var K=null;rr(e,w,K,d)}}b.first=e.first&&e.first.e,b.last=h&&h.e}function sr(t,e,n,i){ct(t.v,e),t.i=n}function lr(t,e,n,i,r,o,a,c,d){var l=(d&mi)!==0,s=(d&yi)===0,u=l?s?wn(r):O(r):r,h=d&gi?O(a):a,p={i:h,v:u,k:o,a:null,e:null,prev:n,next:i};try{return p.e=Ie(()=>c(t,u,h),xi),p.e.prev=n&&n.e,p.e.next=i&&i.e,n===null?e.first=p:(n.next=p,n.e.next=p.e),i!==null&&(i.prev=p,i.e.prev=p.e),p}finally{}}function Fn(t,e,n){for(var i=t.next?t.next.e.nodes_start:n,r=e?e.e.nodes_start:n,o=t.e.nodes_start;o!==i;){var a=Xe(o);r.before(o),o=a}}function ee(t,e,n){e===null?t.first=n:(e.next=n,e.e.next=n&&n.e),n!==null&&(n.prev=e,n.e.prev=e&&e.e)}function cr(t,e,n,i){var r=t.__attributes??(t.__attributes={});r[e]!==(r[e]=n)&&(n==null?t.removeAttribute(e):typeof n!="string"&&dr(t).includes(e)?t[e]=n:t.setAttribute(e,n))}var Un=new Map;function dr(t){var e=Un.get(t.nodeName);if(e)return e;Un.set(t.nodeName,e=[]);for(var n,i=Oe(t),r=Element.prototype;r!==i;){n=rt(i);for(var o in n)n[o].set&&e.push(o);i=Oe(i)}return e}function Gn(t,e,n){if(n){if(t.classList.contains(e))return;t.classList.add(e)}else{if(!t.classList.contains(e))return;t.classList.remove(e)}}function hr(t,e,n=e){var i=Ye();Vi(t,"input",()=>{var r=Zn(t)?Vn(t.value):t.value;n(r),i&&r!==(r=e())&&(t.value=r??"")}),Qe(()=>{var r=e();Zn(t)&&r===Vn(t.value)||t.type==="date"&&!r&&!t.value||r!==t.value&&(t.value=r??"")})}function Zn(t){var e=t.type;return e==="number"||e==="range"}function Vn(t){return t===""?null:+t}function Kn(t,e){return t===e||(t==null?void 0:t[oe])===e}function ur(t={},e,n,i){return An(()=>{var r,o;return Qe(()=>{r=o,o=[],ae(()=>{t!==n(...o)&&(e(t,...o),r&&Kn(n(...r),t)&&e(null,...r))})}),()=>{Ct(()=>{o&&Kn(n(...o),t)&&e(null,...o)})}}),t}function Et(t=!1){const e=_,n=e.l.u;if(!n)return;let i=()=>Gi(e.s);if(t){let r=0,o={};const a=je(()=>{let c=!1;const d=e.s;for(const l in d)d[l]!==o[l]&&(o[l]=d[l],c=!0);return c&&r++,r});i=()=>g(a)}n.b.length&&Ei(()=>{Xn(e,i),an(n.b)}),ln(()=>{const r=ae(()=>n.m.map(Yt));return()=>{for(const o of r)typeof o=="function"&&o()}}),n.a.length&&ln(()=>{Xn(e,i),an(n.a)})}function Xn(t,e){if(t.l.s)for(const n of t.l.s)g(n);e()}let ze=!1;function pr(t){var e=ze;try{return ze=!1,[t(),ze]}finally{ze=e}}function Yn(t){for(var e=b,n=b;e!==null&&!(e.f&(j|qe));)e=e.parent;try{return V(e),t()}finally{V(n)}}function Ne(t,e,n,i){var E;var r=(n&bi)!==0,o=!be||(n&vi)!==0,a=(n&ki)!==0,c=(n&Ai)!==0,d=!1,l;a?[l,d]=pr(()=>t[e]):l=t[e];var s=oe in t||ti in t,u=((E=me(t,e))==null?void 0:E.set)??(s&&a&&e in t?w=>t[e]=w:void 0),h=i,p=!0,f=!1,m=()=>(f=!0,p&&(p=!1,c?h=ae(i):h=i),h);l===void 0&&i!==void 0&&(u&&o&&li(),l=m(),u&&u(l));var y;if(o)y=()=>{var w=t[e];return w===void 0?m():(p=!0,f=!1,w)};else{var v=Yn(()=>(r?je:sn)(()=>t[e]));v.f|=ei,y=()=>{var w=g(v);return w!==void 0&&(h=void 0),w===void 0?h:w}}if(!(n&wi))return y;if(u){var P=t.$$legacy;return function(w,N){return arguments.length>0?((!o||!N||P||d)&&u(N?y():w),w):y()}}var I=!1,B=!1,x=wn(l),S=Yn(()=>je(()=>{var w=y(),N=g(x);return I?(I=!1,B=!0,N):(B=!1,x.v=w)}));return r||(S.equals=vn),function(w,N){if(arguments.length>0){const K=N?g(S):o&&a?pe(w):w;return S.equals(K)||(I=!0,M(x,K),f&&h!==void 0&&(h=K),ae(()=>g(S))),w}return g(S)}}function qt(t){_===null&&Di(),be&&_.l!==null?fr(_).m.push(t):ln(()=>{const e=ae(t);if(typeof e=="function")return e})}function fr(t){var e=t.l;return e.u??(e.u={a:[],b:[],m:[]})}const mr="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(mr);pi();function Rt(t){let e=t.length;for(;e!=0;){let n=Math.floor(Math.random()*e);e--,[t[e],t[n]]=[t[n],t[e]]}return t}function gr(t){const n=new Date().getTime()-t.getTime();if(n<0)throw new Error("The provided date is in the future.");const i=Math.floor(n/(1e3*60*60)),r=Math.floor(n%(1e3*60*60)/(1e3*60)),o=Math.floor(n%(1e3*60)/1e3);return[i.toString().padStart(2,"0"),r.toString().padStart(2,"0"),o.toString().padStart(2,"0")].join(":")}var yr=de('<form class="svelte-sav0zk"><fieldset class="svelte-sav0zk"></fieldset> <footer class="svelte-sav0zk"><button type="submit" class="disabled:hidden svelte-sav0zk">Submit</button></footer></form>');function br(t,e){_n(e,!1);let n=Ne(e,"onSubmit",8),i=Ne(e,"answered",8,!1),r=Ne(e,"src",8),o=X(document.createElement("fieldset"));function a(l){l.preventDefault();const s=l.target;if(!(s instanceof HTMLFormElement))throw new Error("Not a form");const h=new FormData(s).get("answer");return n()(h==="correct"),!0}qt(()=>{var u;lt(o,g(o).innerHTML=r());const l=g(o).querySelector("ul");if(!l)throw new Error("No answer set");const s=Rt(Array.from(l.children));for(const h of s){const p=h.innerHTML,f=((u=h.textContent)==null?void 0:u.startsWith("✅"))??!1,m=document.createElement("label");m.className="grid grid-cols-[1.5rem,1fr] gap-x-2 items-baseline",m.innerHTML=p.replace(/[✅❌] /g,"");const y=document.createElement("input");y.type="radio",y.name="answer",y.required=!0,f&&(y.value="correct"),m.prepend(y),h.replaceChildren(m),h.className="mb-4",l.appendChild(h)}}),Et();var c=yr(),d=q(c);ur(d,l=>M(o,l),()=>g(o)),J(()=>cr(c,"data-answered",i())),Ge("submit",c,a),re(t,c),Pn()}const vr=`## Question: 1 of 125\r
\r
...
`+this.renderer.text(l);n?i+=this.renderer.paragraph({type:"paragraph",raw:s,text:s,tokens:[{type:"text",raw:s,text:s,escaped:!0}]}):i+=s;continue}default:{const l='Token with "'+d.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return i}parseInline(e,n=this.renderer){var r,o;let i="";for(let a=0;a<e.length;a++){const c=e[a];if((o=(r=this.options.extensions)==null?void 0:r.renderers)!=null&&o[c.type]){const l=this.options.extensions.renderers[c.type].call({parser:this},c);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(c.type)){i+=l||"";continue}}const d=c;switch(d.type){case"escape":{i+=n.text(d);break}case"html":{i+=n.html(d);break}case"link":{i+=n.link(d);break}case"image":{i+=n.image(d);break}case"strong":{i+=n.strong(d);break}case"em":{i+=n.em(d);break}case"codespan":{i+=n.codespan(d);break}case"br":{i+=n.br(d);break}case"del":{i+=n.del(d);break}case"text":{i+=n.text(d);break}default:{const l='Token with "'+d.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return i}}class Me{constructor(e){C(this,"options");C(this,"block");this.options=e||he}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}provideLexer(){return this.block?H.lex:H.lexInline}provideParser(){return this.block?L.parse:L.parseInline}}C(Me,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));class Kr{constructor(...e){C(this,"defaults",Mn());C(this,"options",this.setOptions);C(this,"parse",this.parseMarkdown(!0));C(this,"parseInline",this.parseMarkdown(!1));C(this,"Parser",L);C(this,"Renderer",Ke);C(this,"TextRenderer",$n);C(this,"Lexer",H);C(this,"Tokenizer",Ve);C(this,"Hooks",Me);this.use(...e)}walkTokens(e,n){var r,o;let i=[];for(const a of e)switch(i=i.concat(n.call(this,a)),a.type){case"table":{const c=a;for(const d of c.header)i=i.concat(this.walkTokens(d.tokens,n));for(const d of c.rows)for(const l of d)i=i.concat(this.walkTokens(l.tokens,n));break}case"list":{const c=a;i=i.concat(this.walkTokens(c.items,n));break}default:{const c=a;(o=(r=this.defaults.extensions)==null?void 0:r.childTokens)!=null&&o[c.type]?this.defaults.extensions.childTokens[c.type].forEach(d=>{const l=c[d].flat(1/0);i=i.concat(this.walkTokens(l,n))}):c.tokens&&(i=i.concat(this.walkTokens(c.tokens,n)))}}return i}use(...e){const n=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(i=>{const r={...i};if(r.async=this.defaults.async||r.async||!1,i.extensions&&(i.extensions.forEach(o=>{if(!o.name)throw new Error("extension name required");if("renderer"in o){const a=n.renderers[o.name];a?n.renderers[o.name]=function(...c){let d=o.renderer.apply(this,c);return d===!1&&(d=a.apply(this,c)),d}:n.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const a=n[o.level];a?a.unshift(o.tokenizer):n[o.level]=[o.tokenizer],o.start&&(o.level==="block"?n.startBlock?n.startBlock.push(o.start):n.startBlock=[o.start]:o.level==="inline"&&(n.startInline?n.startInline.push(o.start):n.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(n.childTokens[o.name]=o.childTokens)}),r.extensions=n),i.renderer){const o=this.defaults.renderer||new Ke(this.defaults);for(const a in i.renderer){if(!(a in o))throw new Error(`renderer '${a}' does not exist`);if(["options","parser"].includes(a))continue;const c=a,d=i.renderer[c],l=o[c];o[c]=(...s)=>{let u=d.apply(o,s);return u===!1&&(u=l.apply(o,s)),u||""}}r.renderer=o}if(i.tokenizer){const o=this.defaults.tokenizer||new Ve(this.defaults);for(const a in i.tokenizer){if(!(a in o))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;const c=a,d=i.tokenizer[c],l=o[c];o[c]=(...s)=>{let u=d.apply(o,s);return u===!1&&(u=l.apply(o,s)),u}}r.tokenizer=o}if(i.hooks){const o=this.defaults.hooks||new Me;for(const a in i.hooks){if(!(a in o))throw new Error(`hook '${a}' does not exist`);if(["options","block"].includes(a))continue;const c=a,d=i.hooks[c],l=o[c];Me.passThroughHooks.has(a)?o[c]=s=>{if(this.defaults.async)return Promise.resolve(d.call(o,s)).then(h=>l.call(o,h));const u=d.call(o,s);return l.call(o,u)}:o[c]=(...s)=>{let u=d.apply(o,s);return u===!1&&(u=l.apply(o,s)),u}}r.hooks=o}if(i.walkTokens){const o=this.defaults.walkTokens,a=i.walkTokens;r.walkTokens=function(c){let d=[];return d.push(a.call(this,c)),o&&(d=d.concat(o.call(this,c))),d}}this.defaults={...this.defaults,...r}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,n){return H.lex(e,n??this.defaults)}parser(e,n){return L.parse(e,n??this.defaults)}parseMarkdown(e){return(i,r)=>{const o={...r},a={...this.defaults,...o},c=this.onError(!!a.silent,!!a.async);if(this.defaults.async===!0&&o.async===!1)return c(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof i>"u"||i===null)return c(new Error("marked(): input parameter is undefined or null"));if(typeof i!="string")return c(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(i)+", string expected"));a.hooks&&(a.hooks.options=a,a.hooks.block=e);const d=a.hooks?a.hooks.provideLexer():e?H.lex:H.lexInline,l=a.hooks?a.hooks.provideParser():e?L.parse:L.parseInline;if(a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(i):i).then(s=>d(s,a)).then(s=>a.hooks?a.hooks.processAllTokens(s):s).then(s=>a.walkTokens?Promise.all(this.walkTokens(s,a.walkTokens)).then(()=>s):s).then(s=>l(s,a)).then(s=>a.hooks?a.hooks.postprocess(s):s).catch(c);try{a.hooks&&(i=a.hooks.preprocess(i));let s=d(i,a);a.hooks&&(s=a.hooks.processAllTokens(s)),a.walkTokens&&this.walkTokens(s,a.walkTokens);let u=l(s,a);return a.hooks&&(u=a.hooks.postprocess(u)),u}catch(s){return c(s)}}}onError(e,n){return i=>{if(i.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+U(i.message+"",!0)+"</pre>";return n?Promise.resolve(r):r}if(n)return Promise.reject(i);throw i}}}const se=new Kr;function k(t,e){return se.parse(t,e)}k.options=k.setOptions=function(t){return se.setOptions(t),k.defaults=se.defaults,Qt(k.defaults),k};k.getDefaults=Mn;k.defaults=he;k.use=function(...t){return se.use(...t),k.defaults=se.defaults,Qt(k.defaults),k};k.walkTokens=function(t,e){return se.walkTokens(t,e)};k.parseInline=se.parseInline;k.Parser=L;k.parser=L.parse;k.Renderer=Ke;k.TextRenderer=$n;k.Lexer=H;k.lexer=H.lex;k.Tokenizer=Ve;k.Hooks=Me;k.parse=k;k.options;k.setOptions;k.use;k.walkTokens;k.parseInline;L.parse;H.lex;var Xr=de('<div class="svelte-1d0jhup"><!></div>'),Yr=de('<fieldset class="fancy"><legend> </legend> <!></fieldset>'),Jr=de('<h2 style="font-size: 1.5rem; font-weight: medium; margin: 0">Final Score</h2> <div style="font-size: 2rem; font-weight: bold; text-align: center; margin-bottom: 1rem" class="score svelte-1d0jhup"> </div> <table style="margin: auto"><tbody><tr><th>Correct</th><td> </td></tr><tr><th>Incorrect</th><td> </td></tr></tbody></table>',1),eo=de('<article><h1 class="font-bold mb-6 svelte-1d0jhup">NHA Baseline Test</h1> <nav class="svelte-1d0jhup"><button type="button" class="svelte-1d0jhup">Previous</button> <div class="timer svelte-1d0jhup">Timer <time class="svelte-1d0jhup"> </time></div> <button type="button" class="svelte-1d0jhup">Next</button></nav> <!></article>');function no(t,e){_n(e,!1);let n=Ne(e,"num_questions",12,5),i=X(),r=X(0),o=X([]),a,c=X(),d=X("00:00:00"),l=X(!1);function s(){g(r)<=g(i).length&&Nn(r)}function u(x){return k(x,{async:!1}).split(/^<h2>.+<\/h2>\n/gm).filter(Boolean)}qt(()=>{M(i,[...u(vr),...u(wr)]),Rt(g(i)),M(i,g(i).slice(0,n())),n(g(i).length),M(o,new Array(n()).fill(void 0)),a=new Date,M(c,setInterval(()=>{M(d,gr(a))},1e3))});function h(x){lt(o,g(o)[g(r)]=x)}Ri(()=>(g(l),g(o),g(c)),()=>{M(l,g(o).every(x=>typeof x=="boolean")),g(l)&&clearInterval(g(c))}),Qi(),Et();var p=eo(),f=W(q(p),2),m=q(f),y=W(m,2),v=W(q(y)),P=q(v),I=W(y,2),B=W(f,2);St(B,()=>g(r)<n(),x=>{var S=Yr(),E=q(S),w=q(E),N=W(E,2);or(N,1,()=>g(i),ir,(K,tn,De)=>{var ke=Xr(),rn=q(ke),on=sn(()=>typeof g(o)[g(r)]=="boolean");br(rn,{get src(){return g(tn)},onSubmit:h,get answered(){return g(on)}}),J(()=>Gn(ke,"hidden",g(r)!==De)),re(K,ke)}),J(()=>{S.disabled=typeof g(o)[g(r)]=="boolean",Ae(w,`Question: ${g(r)+1} of ${n()??""}`)}),re(x,S)},x=>{var S=Jr(),E=W(pt(S),2);const w=sn(()=>g(o).filter(Boolean).length/n()*100<70);J(()=>Gn(E,"failed",g(w)));var N=q(E);J(()=>Ae(N,`${(g(o).filter(Boolean).length/n()*100).toFixed(2)??""}%`));var K=W(E,2),tn=q(K),De=q(tn),ke=W(q(De)),rn=q(ke);J(()=>Ae(rn,`${g(o).filter(Boolean).length??""} out of ${n()??""}`));var on=W(De),Lt=W(q(on)),jt=q(Lt);J(()=>Ae(jt,`${g(o).filter(Ft=>!Ft).length??""} out of ${n()??""}`)),re(x,S)}),J(()=>{m.disabled=g(r)===0,Ae(P,g(d)),I.disabled=g(r)===n()||typeof g(o)[g(r)]!="boolean"}),Ge("click",m,()=>Nn(r,-1)),Ge("click",I,s),re(t,p),Pn()}var to=de('<header class="mb-6"><h1 class="mb-2 text-5xl font-bold">The Quizzler</h1> <p class="text-center text-xl">Medical Coding Edition</p></header> <fieldset class="fancy flex flex-col items-center justify-center gap-2"><label for="numquestions">How many questions?</label> <input type="number" id="numquestions" min="1" class="pl-2 py-1 rounded border border-neutral-300 dark:border-neutral-600"> <button class="mt-4">Start</button></fieldset>',1),io=de("<main><!></main>");function ro(t){let e=X(225),n=X(!1);var i=io(),r=q(i);St(r,()=>!g(n),o=>{var a=to(),c=W(pt(a),2),d=W(q(c),2),l=W(d,2);hr(d,()=>g(e),s=>M(e,s)),Ge("click",l,()=>M(n,!0)),re(o,a)},o=>{no(o,{get num_questions(){return g(e)}})}),re(t,i)}nr(ro,{target:document.getElementById("app")});
