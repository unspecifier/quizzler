...
Confidentiality is a concept that maintains the security of patient health information by restricting patient information and access to those who do not have
...
This concept gives covered enteties permission to use specified protected health information (PH))
## Question 3 of 15
...
A billing and coding specialist is preparing to code an anesthesiologist's portion of a procedure. The specialist must be able to identify the correct
start/stop times to code the claim correctly. Which of the following regulates this activity?
...
leral Claims Collecti

INCORRECT

The FCA allows Medicare Administrative Contractors (MAC) to collect claims overpayments from health care providers and beneficiaries.
...
ing and coding specialist should identify that which of the following documents assists providers in determining whether there are any
outstanding claims ?
...
‘An aging report assists providers in determining an outstanding claim. It includes information about claims that are current, 30 days overdue, 60 days overdue,
and 90 days overdue.
...
Acredit report is a consumer report of an individual's credit history.
...
A billing and coding specialist notices that a provider is reporting the same code for all new patient visits to get higher reimbursements. The
specialist should identify this as which of the following?

‘The specialist should identify that this situation indicates fraud because the provider is intentionally not following guidelines for determining medical necessity
...
‘Adlean claim includes all required data elements to process and reimburse the claim and is paid in full upon submission.
...
ig specialist should identify that the Office of Inspector General (O1G) has which of the following roles?
...
tient Protection and Affor

This is not a responsibility of the OIG.

identify Medicare fraud al
...
A billing and coding specialist is speaking with a patient on the telephone about their plan benefits. Which of the following actions should the
specialist take when communicating with the patient?
...
‘The specialist should ask for payment for services. However, they should avoid demanding payment for services because the patient might form an opinion on
...
HCPCS Level Il codes are used to report drugs administered in the outpatient environment, not toxoids.

is sedation

INCORRECT

HCPCS Level Il codes are used to report drugs administered in the outpatient environment, not conscious sedation.
## Question 11 of 25
[A] Fac

A billing and coding specialist is completing a claim for a new patient who reports swelling in their ankles. The provider performs an appropriate
history and examination, with high complexity medical decision-making, spending 60 min with the patient. Which of the following Evaluation and
Management (E/M) codes should the specialist select?

making

INCORRECT

mergency department visit of a patient which r ally appropriate history and/or examination and high medical decision-
...
established patient which requi amination and mode!
...
atient vis established patient which requi
...
Time Remaining: 01:05:04

Complete the following question by referencing the coding exhibit.

Abllling and coding specialist should use which of the following CPT® procedure code(s) to report a screening CT colonography?
...
74261. Computed tomographic colonography, diagnostic, including image
postprocessing; without contrast material
Computed tomographic colonography, diagnostic, including image
postprocessing; with contrast material(s) including non-contrast Images, if performed

Computed tomographic colonography, screening, including image
postprocessing
...
PTS code 74150 identifies computed tomography, abdamen, without contrast material. CPT® code 74262 identiias computed tomographic calonegraphy,
screening, including image postprocessing. This description does not match the procedural documentation.

INCORRECT

PTS code 74261 identifies computed tomographic colonography, diagnasti, including image postprocessing without contrast material. This description dos not
‘match the procedural documentation

[CORRECT] wr

(CPT® code 74263 identifies computed tomographic colonography, screening. including image postprocessing. This description matches the procedural
documentation ofthe purpose ofthe test fora screening,

INCORRECT

CPT® code 74262 identifies computed tomography, abdamen, with contrast material, incluing non-contrast images if performed. This descrintion does not
match the procedural documentation
## Question 13 of 25
...
Which of the following HCPCS modifiers indicates the anatomical location of left hand, fifth

Modifier Description

FA Left hand, thumb

F2 Left hand, third di
Fa Left hand, fifth digit
9 Right hand, fifth digit
...
Abilling and coding special
right femur fracture?

is coding an initial encounter with a provider. Which of the following ICD-10-CM codes should be used to report a
...
Ath character is required to report the code to the highest level of specificity and "A" in ICD-10-CM Chapter 19 indicates an initial encounter for a closed fracture.

unspecified

+ of neck of left femur, initial encounter for closed

INCORRECT

This code reports an initial encounter for a closed left femur fracture, not a closed right femur fracture.

2.001 Fracture of unspecified
...
This code reports an initial encounter for a closed right femur fracture, Per ICD-10-CM coding guidelines, if a fracture is not reported as open or closed the default
code should be reported as dosed.

$72,0018 Fracture of ur

INCORRECT

specified part

This code reports an initial encounter for an open right femur fracture. Per ICD-10-CM coding guidelines, if fracture is not reported as open or closed, the default
code should be reported as dosed.
## Question 15 of 25
...
by the same physician or other qualified health care professional on
...
evaluation and management se

physician or other qua are professional during a postoperative

CPT® modifier 24 indicates an Evaluation and Management (E/M) service was performed by the same provider during a postoperative period that is unrelated to
the recovery from the surgical procedure.
...
Which of the following Evaluation and Management (E/M) codes is used to report o1
min?

1e communication with an established patient la
...
99421 Online digital evaluation and management service, for an established patient, for up to 7 days, cumulative time during the 7 days: 5-10
minutes

INCORRECT

E/M code 99421 meets the requirements of online digital face-to-face evaluation for an established patient; however, the total time recorded exceeds the listed
time of Sto 10 min.

99422 Online digital evaluation and management service, for an established patient, for up to 7 days cumulative time during the 7 days: 11-20
minutes

AS CORRECT wy

E/M code 99422 meets the requirements of online digital face-to-face evaluation for an established patient, and the total time recorded is within the listed time of
11 t0.20 min.

99423 Online digital evaluation and management service, for an established patient, for up to 7 days, cumulative time during the 7 days: 21 or
more minutes

INCORRECT

E/M code 99423 meets the requirements of online digital face-to-face evaluation for an established patient; however, the listed time of 21 min or more exceeds
the total time recorded,
## Question 18 of 25


A provider orders a bedside commode without further details. The supply company has multiple types available, so their billing specialist queries
the provider. The provider sends a new order for an extra wide, heavy-duty commode chair. Which of the following HCPCS codes should the
specialist use?

£0163 Commo: with fixed arms
...
ig specialist is processing a claim for a patient who has hypoglycemia. In the term hypoglycemia, the prefix hypo- means which of
...
99231 Subsequent hospital inpatient or observation care, per day. which requires a medically appropriate history and/or examination and
straightforward or low level of medical decision-making
...
A billing and coding specialist is preparing a claim for a patient who has chronic tonsil
occurring with the tonsils?

is. According to the suffix -itis, which of the following is

INCORRECT

Abnormal condition is indicated by the suffix -osis.
...
Simple (single layer) repair of wounds of scalp, neck, axillae, external genitalla, trunk, and/or extremities (including hands and feet); 2.5,
12001 em or lesss

Repair, intermediate (layered closure) wounds of scalp, axillae, trunk, and/or extremities (Including hands and feet); 2.5 cm or less

12031
Repair, intermediate (layered closure) wounds of face, ears, eyelids, nose, lips, and/or mucous membranes; 2.5 cm or less
12051
Repair, complex (layered closure requiring additional corrections) scalp, arms, and/or legs; 1.1 cm to 2.5 cm
13120

[D CORRECT) me

CCPT® code 12001 identifes a simple repair of superficial wounds ofthe scalp measuring 25 cm or less. This description matches the procedural documentation of
the site of closure asthe scalp and the size of 2 em.

INCORRECT

(CPT® code 12031 identifies an intermediate repair of wounds of the scalp measuring 2.5 em or les. This description does not match the procedural
documentation.

INCORRECT

CCPT® code 12051 identifies an intermaciate repsir of wounds ofthe face meaturing 2.5 em or less. This description does nat match the procedural
documentation.

INCORRECT

(CPT® code 13120 identifies @ complex repair of wounds of the scalp measuring 1.1 em to 25 em. This description does not match the procedural documentation
## Question 24 of 25

Time Remaining: 00:51:31

Complete the following question by referencing the coding exhibi

ACRNA provides anesthesia services for a cholecystectomy procedure. Which of the following modifiers should be appended to the service code?
...
-QX Qualified non-physician anesthetist with medical direction by a
physician

QZ Certified registered nurse anesthetist (CRNA) without medical
...
Which of the following ICD-10-CM codes should a billing and coding specialist use for an encounter for human immunodeficiency virus (HIV)
testing?

3 Encounter for screening for infe xual mode of transmission

INCORRECT

ions with a predominantly s
...
1.51 Encounter for screening for human papillorr
...
The ICD-10-CM code 271.7 identifies HIV counseling.
Time Remaining: 01:
...
A child received a measles, mumps, rubella, and varicella (MMRV) vaccine with provider counseling. Which of the following CPT® codes should be
reported for the vaccine and administration?

ICD-10-CM Code Set
Code Description
90460 Immunization administration through 18 years of age via any route

of administration, with counseling by physician; first or only
component of each vaccine or toxoid administered

90461 each additional vaccine or toxold administered

90471 Immunization administration (Includes percutaneous, intradermal,
subcutaneous, or Intramuscular); one vaccine (single or
...
(CPT® code 90707 indicates the measles, mumps, and rubella (MMR) vaccine and code 90716 identifies the varicella virus vaccine (VAR). Since a combination code
(GO710 MMRV) exists, it must be ured when performed. Administration codes 90471 and 90472 report administration without counseling,

INCORRECT
(CPT® code 90707 indicates the measles, mumps, and rubelis (MMR) vaccine and code 90716 identifies the varicella virus vaccine (VAR), Since a combination code

(60710 MMRV) exists it must be used when performed. Since there are four separate components in MMRY, code SO4E0 is used with code S046! x 3to report the
‘eministration and counseling,

INCORRECT

Although MMV is one vaccine, there are four separate components, and code $0460 is used with code $0461 x 3 t0 report the administration and counseling.

CORRECT
(CPT® code $0710 indicates the measles, mumps, rubella, and varicella (MMRV) vaccine, which are used with an administration and counseling code for the
Injection service. Since there are multiple components to MMRV, code S060 is reported for the Fist component and S0461 x 3 for the remaining components.
## Question 3 of 25
...
## Question 40f25 |< CORRECT |


Complete the following question by referencing the coding ex\

ing and coding spe is coding a patient's visit with a provider. After querying the provider, the diagno:
diabetes mellitus with hyperglycemia. Which of the following codes should the specialist use for this condition?

is confirmed to be type 1

ICD-10-CM Code Set

Code Description

£10.65 Type 1 diabetes mellitus with hyperglycemi
£10.9 Type 1 diabetes mellitus without complications
£11.65 Type 2 diabetes mellitus with hyperglycemia
E11.9 Type 2 diabetes mellitus without complications
R73.9 Hyperglycemia, unspecified

INCORRECT

Code £10.9 reporss type 1 diabetes mellitus without complications and code R739 reports hyperglycemia with a category nate that excludes it from being
reported with diabetes codes (E08-£13).
...
£10.65 reports type 1 diabetes mellitus with hyperglycemia.

INCORRECT

Code £11.65 reports type 2, not type 1, diabetes mellitus with hyperglycemia.
01:10:37
...
Category 234 is used to report encounters for supervision of a normal pregnancy.

for supervision of norm
...
Question:60f25 | CORRECT)

Complete the following question by referencing the coding exhibit.

Abilling and coding spe: is coding a claim for a surgery. After querying the provider. it is determined that the documentation supports an
open-approach hysterectomy with colpo-urethrocystopexy. Which of the following CPT® codes should be reported?
...
58267 Vaginal hysterectomy, for uterus 250 g or less, with removal of
...
Which of the following CPT® modifiers indicates the same provider returns to the operating room for surgical treatment of a complication that
resulted from the initial procedure?
...
CPT® modifier 78 indicates an unplanned return to the operating room by the same provider following the initial procedure for a related procedure during the
...
A patient presents to their provider's office with a sore throat, and the provider diagnoses acute and chronic tons
10-CM codes should the billing and coding specialist use for this diagnosis?

is. Which of the following ICD-
...
‘The ICD-10-CM code J02.9 identifies acute pharyngitis, sore throat. The ICD-10-CM code |31.2 identifies chronic pharyngitis, sore throat. Since sore throat is a
symptom of tonsilltis, the sore throat diagnoses are not reported.
...
The ICD-10-CM code J35.01 identifies chronic tonsilltis and J03.90 identifies acute tonsillitis. When both acute and chronic exist, the specialist should code acute
first. Both codes are required for a complete diagnosis.

‘The ICD-10-CM code J03.90 identifies acute tonsillitis and J35.01 identifies chronic tonsillitis. When both acute and chronic exist, the specialist should code acute
first. Both codes are required for a complete diagnosis.
## Question 9 of 25
...
99396 Periodic comprehensive preventive medicine evaluation and management of an individual including an age and gender appropriate
history, examination, counseling/anticipatory guidance/risk factor reduction interventions, and the ordering of laboratory/diagnostic procedures,
...
@ e208 OF ce oF other outpatient visit for a new patient which requires a medically appropriate history and/or examination and high medical
—" decision-making
...
A minor patient, whose parents are married, is covered under both parents’ group insurance plans and also has Medicaid benefits. Parent A has a
birthdate of June 6, 1988 and parent B has a birthdate of October 23, 1987. Which of the following third-party payers should be billed as the
primary?

According to the birthday rule, which states the parent whose birthday comes first in the calendar year is the primary, parent A's insurance would be billed as the
primary.
...
ig specialist is reviewing a patient's record. The specialist should recognize that which of the following should be
there is a concern that Medicare might not pay for the service?
...
members of the military and their family
## Question 5 of 15

ing: 00:42:00


A billing and coding specialist is calculating a patient's financial responsibility for a procedure. The charge for the procedure is $1,400 and the
provider is in the patient's insurance provider's network. The allowable amount for the procedure is $500 with no deductible required. If the
insurance plan pays at 80/20, what is the patient's total coinsurance amount?
...
A billing and coding specialist is reviewing a patient's insurance coverage and notices that the patient is covered by two group insurance plans:
one through their own employer and one through their partner's employer. The specialist should recognize that which of the following is true
regarding the client's primary insurance coverage?

) Primary

INCORRECT

e is determined by the birthday rule.
...
‘The patient's own plan is primary while the patient's partners plan is secondary. The amount of the deductible does not determine primary and secondary
...
A patient fell and was injured while picking up a catering order during their break for an all-employee staff meeting. Which of the following third-
party payers is responsible for this encounter?
...
A billing and coding specialist is submitting a claim for a patient who experienced an injury from a fall during their lunch break away from the
building. The specialist should recognize that which of the following is the correct primary payer for the claim?
...
A billing and coding specialist is preparing a claim for a 16-year-old patient. Which of the following should be contacted to verify the child's
demographics?
...
A patient who has Medicare coverage requests a pain medication refill following hip replacement surgery. For which of the following parts of
Medicare should the patient's eligibility be verified for the prescription?
...
A patient is scheduled for a procedure with an allowed amount of $2,500, and the annual deductible of $700 has been met. The coinsurance
agreement is 70/30. Which of the following is the patient's responsi
...
Medicare Part C, also known as the Medicare Advantage Plan, covers Part A, Part 8, and additional services, such as vision and dental services.
...
A patient completes their provider's office registration forms and provides a military ID with a TRICARE card. The billing and coding specialist
should use which of the following to verify the patient's third-party payer eligibility?
...
A billing and coding specialist is speaking with a patient on the phone regarding the fixed amount due for an upcoming visit. Which of the
following terms refers to a fixed payment due per visit?
...
Coinsurance is the percentage agreement between the third-party payer and the patient. For example, the third-party payer pays 80% while the patient is
responsible for 20%.
## Question 1 of 25
...
ng report breakdown of a patient's
...
After a claim is processed by a third-party payer, which of the following actions should a billing and coding specialist take to collect the remaining
allowed amount?
...
Ithas already been determined that the balance falls under patient financial responsibility, so legally the provider must collect that debt from the client.
...
This unpaid claim should be reviewed first. The provider needs to file claims with the third-party payer in a timely manner, so the specialist should focus first on
unpaid claims that are 31 to 60 days old.
...
Since the payer determined the allowed amount was $80.00 and reimbursed $80.00, the patient financial responsibility is $0.00. The remainder should be written
off and there would be no need to appeal.
o1ti7
...
ich of the following resources is used to understand Medicare coverage circumstances such as indications and coding g
...
Mutually exclusive edits identify issues such as code combinations that are restricted by CPT® guidelines or procedures that cannot be reasonably performed
during the same encounter. They do not provide coverage circumstances such as indications and coding guidance.
...
A billing and coding specialist is reviewing a claims denial for a surgical procedure. After reviewing the original claim, it is determined that services
should have been paid. Which of the following scenarios eliminates the need for prior authorization?
...
A patient has Medicare and TRICARE insurance plans. Which of the following should be collected as patient financial responsi
procedure?
...
the charges adjusted off the patien
...
ealth record (EHR) scrubbing tool
...
A claim is denied with a reason code that the service was not medically necessary. Which of the following actions should a billing and coding
specialist take next to process the appeal?

nial with the re

n code and make a note in ti
...
nosis entered in the provider note.
...
aims are sorted by payer type and are examined fo!
...
A billing and coding specialist is reviewing a partially paid claim that was submitted without modifier 22 for increased procedural services. Which
of the following actions should the specialist take to obtain accurate reimbursement?
...
Contacting the patient for additional reimbursement is incorrect because itis a billing error, which is not the patient's responsi

lity

Post the payment and wr

INCORRECT

the differe

Posting the payment and writing off the difference is incorrect because itis a billing error, which must be adjusted with the third-party payer.
## Question 18 of 25


Which of the following information is required by third-party payers when processing a CMS-1500/837P claim?

Prior medical provide!
...
Which of the following is a unique HIPAA-mandated number that is required to submit a claim for surgical procedures performed by a thoracic
surgeon?

onal provider identifier
...
Abilling and coding specialist is reviewing claims for submission. Which of the followit

is considered a charge capture error?
